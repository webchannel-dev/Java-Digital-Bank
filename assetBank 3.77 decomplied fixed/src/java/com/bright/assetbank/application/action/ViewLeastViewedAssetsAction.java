...
/*     */ 
/*     */ public class ViewLeastViewedAssetsAction extends Bn2Action
/*     */ {
...
/*     */     throws Bn2Exception
/*     */   {
/*  64 */     this.m_logger.debug("In ViewLeastViewedAssetsAction.execute");
...
/*     */     }
/*     */ 
/*  87 */     SearchResults srAssets = this.m_assetManager.getAssetsByViews(AssetBankSettings.getNumberMostPopularAssets(), userProfile, iPageIndex, iPageSize, userProfile.getCurrentLanguage().getCode(), false);
/*     */ 
 ...
 * Qualified Name:     com.bright.assetbank.application.action.ViewLeastViewedAssetsAction
