...
/*    */ 
/*    */ public class AddMarketingGroupAction extends MarketingGroupAction
...
/*    */     {
/* 70 */       this.m_logger.error("AddMarketingGroupAction.execute : User must be an administrator.");
...
/*    */     }
/*    */ 
/* 82 */     getMarketingGroupManager().addMarketingGroup(a_dbTransaction, form.getGroup());
/*    */ 
/* 84 */     return createRedirectingForward("", a_mapping, "Success");
/*    */   }
/*    */ 
 ...
 * Qualified Name:     com.bright.assetbank.marketing.action.AddMarketingGroupAction
