...
/**
 *
 * @author mamatha CommandLineExecHandysaw
/*     */ 
...
/*     */ 
/*     */ public class CommandLineExecHandysaw
/*     */ {
...
/*     */       //System.out.println("after rt.execute");
/* 114 */       StreamGobblerHandysaw errorGobbler = new StreamGobblerHandysaw(proc.getErrorStream(), a_sbErrors, a_sOutputCharSet);
/* 119 */       StreamGobblerHandysaw outputGobbler = new StreamGobblerHandysaw(proc.getInputStream(), a_sbOutput, a_sOutputCharSet);
...
/*     */       }
               //System.out.println(outputGobbler.m);
/*     */     }
/*     */     catch (Throwable t)
/*     */     {
                System.out.println(t.getMessage());
/* 172 */       throw new Bn2Exception(t.getMessage(), t);
/*     */     }
/*     */     finally
/*     */     {
/* 177 */       if (proc != null)
...
/*     */     }
/*     */     //System.out.println("Execute fn: " +sDebugCommand);
