...
/*    */ 
/*    */ public class ViewDeleteStorageDeviceAction extends BaseStorageDeviceAction
/*    */ {
...
/*    */ 
/* 62 */     StorageDevice device = getStorageDeviceManager().getDeviceFromDatabase(a_dbTransaction, lId, true);
/*    */ 
/* 64 */     form.setDevice(device);
/*    */ 
/* 66 */     long lFreeSpace = getStorageDeviceManager().getTotalFreeSpace(a_dbTransaction, device.getType(), device.getId());
/* 67 */     if ((lFreeSpace >= 0L) && (lFreeSpace < device.getFreeSpaceSafetyMargin()))
/*    */     {
/* 69 */       form.setRequiredForStorage(true);
/*    */     }
/*    */ 
 ...
 * Qualified Name:     com.bright.framework.storage.action.ViewDeleteStorageDeviceAction
