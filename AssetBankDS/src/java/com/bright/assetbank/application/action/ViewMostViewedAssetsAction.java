...
/*     */ 
/*     */ public class ViewMostViewedAssetsAction extends Bn2Action
/*     */ {
...
/*     */     throws Bn2Exception
/*     */   {
/*  64 */     this.m_logger.debug("In ViewMostViewedAssetsAction.execute");
...
/*     */     }
/*     */ 
/*  87 */     SearchResults srAssets = this.m_assetManager.getAssetsByViews(AssetBankSettings.getNumberMostPopularAssets(), userProfile, iPageIndex, iPageSize, userProfile.getCurrentLanguage().getCode(), true);
/*     */ 
 ...
 * Qualified Name:     com.bright.assetbank.application.action.ViewMostViewedAssetsAction
