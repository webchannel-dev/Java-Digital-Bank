...
/*     */ 
/*     */ public class ViewMostDownloadedAssetsAction extends Bn2Action
/*     */ {
...
/*     */     throws Bn2Exception
/*     */   {
/*  64 */     this.m_logger.debug("In ViewMostDownloadedAssetsAction.execute");
...
/*     */     }
/*     */ 
/*  87 */     SearchResults srAssets = this.m_assetManager.getAssetsByDownloads(AssetBankSettings.getNumberMostPopularAssets(), userProfile, iPageIndex, iPageSize, userProfile.getCurrentLanguage().getCode(), true);
/*     */ 
 ...
 * Qualified Name:     com.bright.assetbank.application.action.ViewMostDownloadedAssetsAction
