...
<body>
	...
	<logic:iterate name="newsForm" property="newsItems" id="newsItem" indexId="newsItemIndex">
		...
		<h2><bean:write name="newsItem" property="name" filter="false"/></h2>
		<p>
			<bean:write name="newsItem" property="content" filter="false"/>
			<c:if test="${newsItem.isTruncated}">
				...
				<br />
				<a href="viewNewsItem?id=<bean:write name="newsItem" property="id" filter="false"/>"><bright:cmsWrite identifier="link-more" filter="false"/></a>
			</c:if>
		</p>
		<div class="hr"></div>
	</logic:iterate>
