...
<c:set var="linkUrl" value="browseExplorerItems?categoryId=${browseItemsForm.category.id}&categoryTypeId=${browseItemsForm.category.categoryTypeId}"/>
<c:set var="explorer" value="true" />
<c:set var="thisUrlForGet" value="viewHome?categoryId=${browseItemsForm.category.id}&categoryTypeId=${browseItemsForm.category.categoryTypeId}" />
