				...
				<logic:greaterThan name="translation" property="language.id" value="0">
					<tr>
						...
						<td>
							...
							<c:choose><c:when test="${categoryForm.category.extensionAssetId > 0}"><input type="hidden" name="category.translations[<bean:write name='tIndex'/>].name" value="<bean:write name='translation' property='name' filter='false'/>" /><bean:write name="translation" property="name" filter="false" /></c:when><c:otherwise><input type="text" class="text" name="category.translations[<bean:write name='tIndex'/>].name" maxlength="150" size="30" id="categoryName<bean:write name='tIndex'/>" value="<bean:write name='translation' property='name' filter='false'/>"/></c:otherwise></c:choose>
						</td>
					</tr>
				</logic:greaterThan>
			</logic:iterate>
