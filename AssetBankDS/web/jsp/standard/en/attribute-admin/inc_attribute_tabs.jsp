<div class="adminTabs">
	...
	<c:choose>
		<c:when test="${tabId == 'attributeSorting'}">
			<h2 class="current">Attribute Sorting</h2>
		</c:when>
		<c:otherwise>
			<h2><a href="viewManageSortAttributes">Attribute Sorting</a></h2>
		</c:otherwise>		
	</c:choose>
	<c:choose>
		...
		<c:otherwise>
			<h2><a href="viewManageDisplayAttributes?daGroupId=1">Display Attributes</a></h2>
		</c:otherwise>		
	</c:choose>
	<c:choose>
