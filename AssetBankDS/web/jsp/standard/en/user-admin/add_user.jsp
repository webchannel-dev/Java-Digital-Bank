...
<head>
	...
	<script type="text/javascript">
		...
		// give the current username field the focus once the dom is ready
		$j(function () {
  			$j('#username').focus();
		});
		...
		<input type="hidden" name="mandatory_user.username" value="Please enter a username." />
			...
			<tr>
				...
				<td colspan="2">
					...
					<a href="#" class="js-enabled-show-inline" onclick="openDatePickerSupportUS(document.getElementsByName('expiryDate')[0], <bean:write name='daysBeforeMonths' />); return false" title="Date chooser"><img class="icon" src="../images/standard/icon/calendar.gif" alt="Date chooser"  width="16" height="15" style="padding-right: 0;" /></a>
