		...
		<div class="adminTabs">
			...
			<c:choose>
				<c:when test="${tabId == 'approved'}">
					<h2 class="current"><bright:cmsWrite identifier="tab-approved-items" filter="false"/></h2>
				</c:when>
				<c:otherwise>
					<h2><a href="../action/viewMyUploads"><bright:cmsWrite identifier="tab-approved-items" filter="false"/></a></h2>
				</c:otherwise>		
			</c:choose>
