...
<body>
	...
	<table cellspacing="0" cellpadding="0" width="100%;" style="margin-top:5px;">
		<tr>
			<td class="left">
				<form name="back" action="../action/metadataImportNew">
					<input type="submit" name="backButton" class="button" value="<bright:cmsWrite identifier="button-back" filter="false" />" style="margin-left: 0;" />
				</form>
			</td>
			<logic:equal name="metadataImportForm" property="fatalError" value="false">
			<td class="right" style="text-align:right">
				<html:form action="metadataStartImport" method="post">
					...
					<input type="submit" name="startButton" class="button" value="Start Update" />
				</html:form>
			</td>
			</logic:equal>
		</tr>
