...
<body id="adminPage">
	...
	<html:form action="saveAgreement" method="post" styleClass="floated">	
		...
		<a href="#" title="Date chooser"><img class="icon js-enabled-show" src="../images/standard/icon/calendar.gif" alt="Date chooser" onclick="openDatePickerSupportUS(document.getElementById('agreementexpiry'),true)" width="16" height="15" /></a>
		<br />
