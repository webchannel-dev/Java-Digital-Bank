...
<body id="checkout">
	...
	<logic:notEmpty name="checkoutForm" property="approvalList">
		...
		<c:if test="${bLoginProfileValid}">
			...
			<bright:refDataList id="mainCopyItem" transactionManagerName="DBTransactionManager" componentName="ListManager" methodName="getListItem" argumentValue="checkout-confirmation-text"/>	
			<logic:notEmpty name="mainCopyItem">
				<logic:notEmpty name="mainCopyItem" property="body">
