				...
				<table cellspacing="0" class="form" summary="Form for list item details">
					...
					<c:if test="${template.language.default}">
						<tr>
							<th>Title:</th>
							<td>
								<input type="text" class="text" name="emailTemplates[<bean:write name='tIndex'/>].code" maxlength="250" size="35" id="code<bean:write name='tIndex'/>" value="<bean:write name="template" property="code" filter="false"/>"/>
						...
						<tr>
							<th>From:</th>
							<td>
								<input type="text" class="text" name="emailTemplates[<bean:write name='tIndex'/>].addrFrom" maxlength="250" size="35" id="from<bean:write name='tIndex'/>" value="<bean:write name="template" property="addrFrom" filter="false"/>"/>
						...
						<tr>
							...
							<td>
								...
								<input type="text" class="text" name="emailTemplates[<bean:write name='tIndex'/>].addrTo" maxlength="250" size="35" id="to<bean:write name='tIndex'/>" value="<bean:write name="toAddress" filter="false"/>"/>
						...
						<tr>
							<th>CC:</th>
							<td>
								<input type="text" class="text" name="emailTemplates[<bean:write name='tIndex'/>].addrCc" maxlength="250" size="35" id="from<bean:write name='tIndex'/>" value="<bean:write name="template" property="addrCc" filter="false"/>"/>
							</td>
						</tr>			
						<tr>
							<th>BCC:</th>
							<td>
								<input type="text" class="text" name="emailTemplates[<bean:write name='tIndex'/>].addrBcc" maxlength="250" size="35" id="from<bean:write name='tIndex'/>" value="<bean:write name="template" property="addrBcc" filter="false"/>"/>
							</td>
						</tr>
					</c:if>
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="emailTemplates[<bean:write name='tIndex'/>].addrSubject" size="35" maxlength="250" value="<bean:write name="template" property="addrSubject" filter="false"/>" />
						</td>
					</tr>			
					<tr>				
