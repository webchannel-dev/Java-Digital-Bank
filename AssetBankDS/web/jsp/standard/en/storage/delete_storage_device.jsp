...
<body id="adminPage">
	...
	<html:form action="deleteStorageDevice" method="get" styleClass="floated">
		...
		<input type="submit" class="button flush" value="Delete" onclick="return confirm('Are you sure you want to remove this device?');" <c:if test="${storageDeviceForm.requiredForStorage}">disabled='disabled'</c:if>> 
