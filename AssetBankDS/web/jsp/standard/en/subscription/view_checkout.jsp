...
<body id="checkout">
	...
	<p class="totals">
		<logic:notEmpty name="subscriptionForm" property="price.taxNumber">
			Your tax number: <bean:write name="subscriptionForm" property="price.taxNumber" filter="false" /><br />
		</logic:notEmpty>
		<logic:notEmpty name="subscriptionForm" property="price.tax.taxRegion.name">
			Tax region: <bean:write name="subscriptionForm" property="price.tax.taxRegion.name" filter="false" /><br />
		</logic:notEmpty>
		
		Subtotal: <bean:write name="subscriptionForm" property="price.subtotalAmount.displayAmount" filter="false" /><br />
		...
		<bean:write name="subscriptionForm" property="price.tax.taxType.name" /> @ <bean:write name="subscriptionForm" property="price.tax.taxPercent.displayNumber" />%: 
			<bean:write name="subscriptionForm" property="price.taxAmountWithoutNumber.displayAmount" filter="false" /><br />
		
		<%-- If tax can be zeroed, show tax amount --%>
		<logic:notEmpty name="subscriptionForm" property="price.taxNumber">
			<c:if test="${subscriptionForm.price.tax.zeroIfTaxNumberGiven}">
				<bean:write name="subscriptionForm" property="price.tax.taxType.name" /> added: <bean:write name="subscriptionForm" property="price.taxAmount.displayAmount" filter="false" /><br />
			</c:if>
		</logic:notEmpty>
		
		<strong>
			Total: <bean:write name="subscriptionForm" property="price.totalAmount.displayAmount" filter="false" />
		</strong><br />
