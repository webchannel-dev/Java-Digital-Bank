...
<body id="adminPage">
		...
		<logic:equal name="categoryAdminForm" property="root" value="false">
			<strong>
				...
				<logic:iterate name="categoryAdminForm" property="ancestorCategoryList" id="ancestorCategory"> &raquo;
					<a href="viewKeywordAdmin?categoryId=<bean:write name='ancestorCategory' property='id' />&categoryTypeId=<bean:write name='categoryAdminForm' property='categoryTreeId'/>"><bean:write name="ancestorCategory" property="name" filter="false"/></a>
				</logic:iterate>
	...
	<h3>Add new keyword to <em><bean:write name='currentCategoryName' filter="false"/></em>:</h3>
	...
	<h3><em><bean:write name='currentCategoryName' filter="false"/></em> keywords:</h3>
