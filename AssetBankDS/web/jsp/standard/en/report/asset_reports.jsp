...
<body id="adminPage">
	...
	<%@include file="../report/inc_report_tabs.jsp"%>
		...
		<html:form action="viewAssetReport" method="get">	
			...
			<div id="reportSelect">
				<label for="startDate">From: <html:text styleClass="small text" name="reportForm" property="startDateString" size="20" styleId="startDate" /> </label>
				...
				&nbsp;
				<label for="endDate">To: <html:text styleClass="small text" name="reportForm" property="endDateString" size="20" styleId="endDate" /> </label>
