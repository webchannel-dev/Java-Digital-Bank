...
<body id="adminPage">
	...
	<html:form action="viewEcommerceReport" method="get">
		...
		<div id="reportSelect">
			<label for="startDate">From:</label> <html:text styleClass="small text" styleId="startDate" name="ecommerceReportForm" property="startDateString" size="20"/> 
			...
			&nbsp;
			<label for="endDate">To:</label> <html:text styleClass="small text" name="ecommerceReportForm" styleId="endDate" property="endDateString" size="20"/> 
	...
	<c:if test="${subscriptionsEnabled}">	
		...
		<html:form action="viewEcommerceReport" method="get">
			...
			<div id="reportSelect">
				...
				<label for="startDate">From:</label> <html:text styleClass="small text" styleId="startDate2" name="ecommerceReportForm" property="startDateString" size="20"/> 
				
				<script type="text/javascript">
					document.write('<a href="javascript:;" title="Date chooser"><img class="icon" src="../images/standard/icon/calendar.gif" alt="Date chooser" onclick="openDatePicker(document.getElementById(\'startDate2\'))" width="16" height="15" style="padding-right: 0;" ><\/a>');
				</script>
				
				<span class="required">*</span> 
				&nbsp;
				<label for="endDate">To:</label> <html:text styleClass="small text" name="ecommerceReportForm" styleId="endDate2" property="endDateString" size="20"/> 
				
				<script type="text/javascript">
					document.write('<a href="javascript:;" title="Date chooser"><img class="icon" src="../images/standard/icon/calendar.gif" alt="Date chooser" onclick="openDatePicker(document.getElementById(\'endDate2\'))" width="16" height="15" style="padding-right: 0;" ><\/a>');
				</script>
