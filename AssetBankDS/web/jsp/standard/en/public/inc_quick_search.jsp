			...
			<div class="commonSaved <logic:notEmpty name="homepageForm" property="userPromotedSearches">middle</logic:notEmpty>">
				...
				<ul>
					<logic:iterate name="homepageForm" property="globalPromotedSearches" id="search">
						<li><c:if test="${search.image != null && search.image != ''}"><a href="runSavedSearch?name=<bright:write name='search' property='name'/>&id=<bean:write name='search' property='userId'/>" class="thumb"><img src="../<bright:write name='search' property='image'/>" alt=""/></a></c:if>
							<a href="runSavedSearch?name=<bright:write name='search' property='name'/>&id=<bean:write name='search' property='userId'/>"><bean:write name='search' property='name'/></a>
						</li>
					</logic:iterate>
				</ul>
			</div>
				...
				<ul>
				   ...
				   %>
					<logic:iterate name="homepageForm" property="userPromotedSearches" id="search" indexId="idx">
						<li>
							<c:if test="${search.image != null && search.image != ''}"><a href="runSavedSearch?name=<bright:write name='search' property='name'/>&id=<bean:write name='search' property='userId'/>" class="thumb"><img src="../<bright:write name='search' property='image'/>" alt=""/></a></c:if>
							<a href="runSavedSearch?name=<bright:write name='search' property='name'/>&id=<bean:write name='search' property='userId'/>"><bean:write name='search' property='name'/></a></li>
