	...
	<table cellpadding="0" cellspacing="0" border="0" class="admin">
		<c:if test="${not empty image.createdByUser}">
			<tr>
				...
				<td><bean:write name="image" property="createdByUser.fullName" filter="false"/> <c:if test="${not empty image.createdByUser.emailAddress}"><bean:write name="image" property="createdByUser.emailAddress" filter="false"/></c:if>
				</td>
			</tr>
		</c:if>
		<tr>
