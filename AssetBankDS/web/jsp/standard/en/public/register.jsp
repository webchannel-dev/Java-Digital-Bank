			...
			<html:form action="registerUser" method="post">
				...
				<c:if test="${useTitle}">																
					...
					<tr>
						...
						<td colspan="2">
							<c:choose>
								<c:when test="${empty localUserEmailDomain || param.externalUser}">
				...
				<c:if test="${!(useBrands && automaticBrandRegistration)}">
               ...
               <tr>
                  ...
                  <td colspan="2" style="padding-top:10px;">
							<input class="button flush floated" type="submit" value="<bright:cmsWrite identifier="button-register" filter="false" />"  />
