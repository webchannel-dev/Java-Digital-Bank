...
<body>
	...
	<ul>
		...
		<li><b>XML file:</b> An xml file that specifies the images to use in the slideshow, the order they are presented in and any associated captions</li>
	...
	<p>Please right click on the following link and select 'Save as' from the menu:</p>
