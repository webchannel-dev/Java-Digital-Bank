...
function uploadStart(fileObj) {
	try {
		...
		progress.ToggleCancel(true, this);
		document.getElementById("flashTitle").innerHTML = "<h3>Uploading (please wait)</h3>";
		document.getElementById("filesUploading").innerHTML = "Files are still uploading";
...
function fileComplete(fileObj) {
	try {
		...
		if (this.getStats().files_queued === 0) {
			document.getElementById("flashTitle").innerHTML = "<h3>Uploading complete</h3>";
			document.getElementById("nextButton").disabled=false;
			document.getElementById("filesUploading").innerHTML = "";
