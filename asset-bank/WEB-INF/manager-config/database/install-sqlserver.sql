...
(
	...
	[IsUnsubmitted] Tinyint Default 0 NOT NULL,
...
(
	...
	[ReactivationPending] Tinyint Default 0 NOT NULL,
	[RequestFulfiller] Tinyint Default 0 NOT NULL,
...
(
	...
	[EnforceUniqueness] Tinyint Default 0 NOT NULL,
...
(
	...
	[AutomaticBrandRegister] Tinyint Default 0 NOT NULL,
	[AdvancedViewing] Tinyint Default 0 NOT NULL,
...
(
	...
	[IsRotatable] Tinyint Default 1 NOT NULL,
	[Name] Nvarchar(255) NULL,
	[Description] Nvarchar(255) NULL,
	[ThumbnailFileLocation] Nvarchar(255) NULL,
...
(
	...
	[ShowOnProfile] Tinyint Default 1 NOT NULL,
...
(
	...
	[Promoted] Tinyint Default 0 NOT NULL,
	[AvailableToAll] Tinyint Default 0 NOT NULL,
	[Featured] Tinyint Default 0 NULL,
	[SearchImage] Nvarchar(250) NULL,
	[NewAssetAlert] Tinyint Default 0 NOT NULL,
	[Description] Ntext NULL,
...
(
	...
	[AttributeId] Integer NOT NULL,
	[IsVisibleOnAdd] Tinyint Default 1 NOT NULL,
	[ValueIfNotVisible] Ntext NULL,
...
(
	...
	[OnlyAllowDefaultCategory] Tinyint Default 0 NOT NULL,
	[RootCategoryId] Integer NULL,
...
(
	...
	[MaintainAspectRatio] Tinyint Default 1 NULL,
	[IncludeLabels] Tinyint Default 0 NOT NULL,
	...
	[ImageWidth] Integer NULL,
	[Description] Nvarchar(255) NULL,
	[ShowOnHomepage] Tinyint Default 0 NOT NULL,
	[IsDefaultOnHomepage] Tinyint Default 0 NOT NULL,
	[SequenceNumber] Integer NULL,
	[SearchCriteriaId] Integer NULL,
	[TextRtl] Tinyint Default 1,
...
(
	...
	[AssetId] Integer NOT NULL,
	[PreviewFileLocation] Nvarchar(255) NULL,
	[RepurposedVersionId] Integer NOT NULL,
...
(
	...
	[AutoUnpublish] Tinyint Default 0 NOT NULL,
...
(
	...
	[LanguageId] Integer NOT NULL,
	[Label] Nvarchar(255) NULL,
Constraint [pk_TranslatedAudioDownloadOption] Primary Key ([AudioDownloadOptionId],[LanguageId])
) 
go
...
(
	[Id] Integer NOT NULL Identity(100,1),
	[SearchCriteriaFile] Nvarchar(255) NOT NULL,
...
(
	...
	[LanguageId] Integer NOT NULL,
	[ValueIfNotVisible] Ntext NULL,
Constraint [pk_TranslatedAssetEntityAttribute] Primary Key ([AssetEntityId],[AttributeId],[LanguageId])
) 
go
...
go
Alter table [InDesignLinkedResource] add Constraint [InDLinked_Asset_Doc_FK] foreign key([AssetId]) references [Asset] ([Id])  on update no action on delete no action 
go
Create Index [IX_InDLinked_Asset_Asset_FK] ON [InDesignLinkedResource] ([LinkedAssetId]) 
go
Alter table [InDesignLinkedResource] add Constraint [InDLinked_Asset_Asset_FK] foreign key([LinkedAssetId]) references [Asset] ([Id])  on update no action on delete no action 
go
...
go
Alter table [WorkflowAudit] add Constraint [Relationship284] foreign key([UserId]) references [AssetBankUser] ([Id])  on update no action on delete no action 
go
...
go
Alter table [UserEditLanguage] add Constraint [User_UserEditLang_FK] foreign key([UserId]) references [AssetBankUser] ([Id])  on update no action on delete no action 
go
...
go
Alter table [AssetEntity] add Constraint [AssetEntity_Cat_Root_FK] foreign key([RootCategoryId]) references [CM_Category] ([Id])  on update no action on delete no action 
go
...
go
Alter table [TranslatedAudioDownloadOption] add Constraint [TADO_LanguageId_fk] foreign key([LanguageId]) references [Language] ([Id])  on update no action on delete no action 
go
Create Index [IX_Lang_UserEditLang_FK] ON [UserEditLanguage] ([LanguageId]) 
go
Alter table [UserEditLanguage] add Constraint [Lang_UserEditLang_FK] foreign key([LanguageId]) references [Language] ([Id])  on update no action on delete no action 
go
Create Index [IX_TranslatedAEA_Language_FK] ON [TranslatedAssetEntityAttribute] ([LanguageId]) 
go
Alter table [TranslatedAssetEntityAttribute] add Constraint [TranslatedAEA_Language_FK] foreign key([LanguageId]) references [Language] ([Id])  on update no action on delete no action 
go
...
go
Alter table [TranslatedAssetEntityAttribute] add Constraint [TranslatedAEA_AEA_FK] foreign key([AssetEntityId],[AttributeId]) references [AssetEntityAttribute] ([AssetEntityId],[AttributeId])  on update no action on delete no action 
go
...
go
Alter table [PublishingLog] add Constraint [PublishingLog_PA_FK] foreign key([PublishActionId]) references [PublishAction] ([Id])  on update no action on delete no action 
go
Create Index [IX_PublishedAsset_PA_FK] ON [PublishedAsset] ([PublishActionId]) 
go
Alter table [PublishedAsset] add Constraint [PublishedAsset_PA_FK] foreign key([PublishActionId]) references [PublishAction] ([Id])  on update no action on delete no action 
go
...
go
Create Index [IX_TADO_AudioDownloadOptionId_FK] ON [TranslatedAudioDownloadOption] ([AudioDownloadOptionId]) 
go
Alter table [TranslatedAudioDownloadOption] add Constraint [TADO_AudioDownloadOptionId_FK] foreign key([AudioDownloadOptionId]) references [AudioDownloadOption] ([Id])  on update no action on delete no action 
go
Create Index [IX_SavedSearch_SearchCrit_FK] ON [SavedSearch] ([SearchCriteriaId]) 
go
Alter table [SavedSearch] add Constraint [SavedSearch_SearchCrit_FK] foreign key([SearchCriteriaId]) references [SearchCriteria] ([Id])  on update no action on delete no action 
go
Create Index [IX_PublishAction_SearchCrit_FK] ON [PublishAction] ([SearchCriteriaId]) 
go
Alter table [PublishAction] add Constraint [PublishAction_SearchCrit_FK] foreign key([SearchCriteriaId]) references [SearchCriteria] ([Id])  on update no action on delete no action 
go
Create Index [IX_RSlideshow_SearchCrit_FK] ON [RepurposedSlideshow] ([SearchCriteriaId]) 
go
Alter table [RepurposedSlideshow] add Constraint [RSlideshow_SearchCrit_FK] foreign key([SearchCriteriaId]) references [SearchCriteria] ([Id])  on update no action on delete no action 
go
Create Index [IX_PubAssetFile_PubAsset_FK] ON [PublishedAssetFile] ([AssetId],[PublishActionId]) 
go
Alter table [PublishedAssetFile] add Constraint [PubAssetFile_PubAsset_FK] foreign key([AssetId],[PublishActionId]) references [PublishedAsset] ([AssetId],[PublishActionId])  on update no action on delete no action 
go
...
SET IDENTITY_INSERT AudioDownloadOption ON;
...
SET IDENTITY_INSERT AudioDownloadOption OFF;
