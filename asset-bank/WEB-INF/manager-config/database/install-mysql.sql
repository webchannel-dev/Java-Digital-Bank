...
Create table Asset (
	...
	Synchronised Bool NOT NULL DEFAULT 0,
	IsPreviewRestricted Bool NOT NULL DEFAULT 0,
	BulkUploadTimestamp Datetime,
	VersionNumber Int NOT NULL DEFAULT 1,
	NumViews Int NOT NULL DEFAULT 0,
	NumDownloads Int NOT NULL DEFAULT 0,
	LastDownloaded Datetime,
	AssetEntityId Bigint,
	OriginalFilename Varchar(255),
	IsSensitive Bool NOT NULL DEFAULT 0,
	AgreementTypeId Int,
	HasSubstituteFile Bool NOT NULL DEFAULT 0,
	IsUnsubmitted Bool NOT NULL DEFAULT 0,
	IsBrandTemplate Bool NOT NULL DEFAULT 0,
	CanEmbedFile Bool NOT NULL DEFAULT 0,
	ThumbnailGenerationFailed Bool NOT NULL DEFAULT 0,
	IsNotDuplicate Bool NOT NULL DEFAULT 0,
	AdvancedViewing Bool NOT NULL DEFAULT 0,
	FileCheckedOutByUserId Bigint,
	FileCheckOutTime Datetime,
	SubmittedByUserId Bigint,
	AllowFeedback Bool NOT NULL DEFAULT 0,
	DateSubmitted Datetime,
	HasNeverBeenApproved Bool NOT NULL DEFAULT 0,
...
Create table AssetBankUser (
	...
	Mailbox Varchar(255),
	NotActiveDirectory Bool,
	Hidden Bool DEFAULT 0,
	NotApproved Bool DEFAULT 0,
	RequiresUpdate Bool DEFAULT 0,
	CanBeCategoryAdmin Bool DEFAULT 0,
	ExpiryDate Date,
	RegisterDate Date,
	...
	ReactivationPending Bool NOT NULL DEFAULT 0,
	RequestFulfiller Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table CM_Category (
	...
	SequenceNumber Int,
	Summary Varchar(255),
	IsBrowsable Bool NOT NULL,
	IsRestrictive Bool NOT NULL DEFAULT 0,
	BitPosition Int,
	IsListboxCategory Bool DEFAULT 0,
	CannotBeDeleted Bool NOT NULL,
	Synchronised Bool NOT NULL DEFAULT 0,
	SelectedOnLoad Bool DEFAULT 0,
	AllowAdvancedOptions Bool DEFAULT 1,
	IsExpired Bool NOT NULL DEFAULT 0,
	WorkflowName Varchar(200),
	CanAssignIfNotLeaf Bool NOT NULL DEFAULT 0,
	ExtensionAssetId Bigint,
	BrowseAsPanels Bool DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table Attribute (
	...
	Label Varchar(255),
	IsKeywordSearchable Bool NOT NULL DEFAULT 0,
	IsMandatory Bool NOT NULL DEFAULT 0,
	...
	Highlight Bool,
	NameAttribute Bool DEFAULT 0,
	DefaultKeywordFilter Varchar(5),
	OnChangeScript Mediumtext,
	IsHtml Bool,
	IsRequiredForCompleteness Bool DEFAULT 0,
	RequiresTranslation Bool DEFAULT 0,
	DisplayName Varchar(255),
	BaseUrl Varchar(255),
	AltText Varchar(255),
	HasSearchTokens Bool NOT NULL DEFAULT 0,
	TokenDelimiterRegex Varchar(20),
	IsDescriptionAttribute Bool,
	Height Int,
	Width Int,
	MaxSize Int,
	IsFiltered Bool,
	Seed Bigint,
	IncrementAmount Int,
	IsExtendableList Bool,
	GetDataFromChildren Bool NOT NULL DEFAULT 0,
	InputMask Varchar(250),
	IsMandatoryBulkUpload Bool NOT NULL DEFAULT 0,
	ShowOnChild Bool NOT NULL DEFAULT 0,
	IncludeInSearchForChild Bool NOT NULL DEFAULT 0,
	Prefix Varchar(40),
	HideForSort Bool NOT NULL DEFAULT 0,
	IsAutoComplete Bool NOT NULL DEFAULT 0,
	PluginClass Varchar(250),
	PluginParamsAttributeIds Varchar(250),
	ValueColumnName Varchar(255),
	ShowOnDownload Bool NOT NULL DEFAULT 0,
	MaxDecimalPlaces Int,
	MinDecimalPlaces Int,
	SinglePointOnly Bool NOT NULL DEFAULT 0,
	DateFormatType Smallint NOT NULL DEFAULT 0,
	AutoCompletePlugin Varchar(255),
	EnforceUniqueness Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table CM_CategoryType (
	...
	IsAlphabeticOrder Bool NOT NULL,
	IsNameGloballyUnique Bool NOT NULL,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetBoxAsset (
	...
	SequenceNumber Int,
 Primary Key (AssetBoxId,AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table CM_ItemInCategory (
	...
	IsApproved Bool,
	LastApprovedByUserId Bigint,
 Primary Key (CategoryId,ItemId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table UserGroup (
	...
	IsDefaultGroup Bool NOT NULL DEFAULT 0,
	Mapping Text,
	BrandId Bigint,
	IPMapping Text,
	URLMapping Text,
	DiscountPercentage Int,
	CanOnlyEditOwn Bool NOT NULL DEFAULT 0,
	DailyDownloadLimit Int NOT NULL DEFAULT 0,
	CanEmailAssets Bool NOT NULL DEFAULT 1,
	CanSeeSourcePath Bool NOT NULL DEFAULT 0,
	CanRepurposeAssets Bool NOT NULL DEFAULT 0,
	MaxDownloadHeight Int,
	MaxDownloadWidth Int,
	CanInviteUsers Bool NOT NULL DEFAULT 0,
	CanAddEmptyAssets Bool NOT NULL DEFAULT 0,
	CanViewLargerSize Bool NOT NULL DEFAULT 1,
	AutomaticBrandRegister Bool NOT NULL DEFAULT 0,
	AdvancedViewing Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AttributeType (
	Id Bigint NOT NULL,
	Name Varchar(60) NOT NULL,
	AttributeStorageTypeId Bigint NOT NULL,
...
Create table ImageAsset (
	...
	UnwatermarkedLargeFileLocation Varchar(255),
...
Create table CategoryVisibleToGroup (
	...
	CategoryId Bigint NOT NULL,
	CanDownloadAssets Bool NOT NULL DEFAULT 0,
	CanDownloadWithApproval Bool NOT NULL DEFAULT 0,
	CanUpdateAssets Bool NOT NULL DEFAULT 0,
	CanUpdateWithApproval Bool NOT NULL DEFAULT 0,
	CanDeleteAssets Bool NOT NULL DEFAULT 0,
	CanApproveAssets Bool NOT NULL DEFAULT 0,
	CantDownloadOriginal Bool NOT NULL DEFAULT 0,
	CantDownloadAdvanced Bool NOT NULL DEFAULT 0,
	CanEditSubcategories Bool NOT NULL DEFAULT 0,
	CantReviewAssets Bool NOT NULL DEFAULT 0,
	CanApproveAssetUploads Bool NOT NULL DEFAULT 0,
	CanViewRestrictedAssets Bool NOT NULL DEFAULT 0,
	ApprRequiredForHighRes Bool NOT NULL DEFAULT 0,
	CanUploadAssets Bool NOT NULL DEFAULT 0,
	CanUploadWithApproval Bool NOT NULL DEFAULT 0,
 Primary Key (UserGroupId,CategoryId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table GroupAttributeExclusion (
 ...
 Primary Key (AttributeId,UserGroupId,Value)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table AttributeVisibleToGroup (
	UserGroupId Bigint NOT NULL,
	AttributeId Bigint NOT NULL,
	IsWriteable Bool NOT NULL DEFAULT 0,
 Primary Key (UserGroupId,AttributeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table UserInGroup (
	UserId Bigint NOT NULL,
	UserGroupId Bigint NOT NULL,
 Primary Key (UserId,UserGroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table UsageType (
	...
	Description Varchar(255),
	SequenceNumber Int NOT NULL,
	IsEditable Bool NOT NULL DEFAULT 1,
	ParentId Bigint,
	DownloadTabId Int NOT NULL DEFAULT 0,
	CanEnterDetails Bool,
	DetailsMandatory Bool,
	Message Text,
	DownloadOriginal Bool,
	IsConsideredHighRes Bool NOT NULL DEFAULT 0,
	CanDownloadAsPPT Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table FileFormat (
	...
	IsIndexable Bool NOT NULL DEFAULT 0,
	IsConvertable Bool NOT NULL DEFAULT 0,
	IsConversionTarget Bool NOT NULL DEFAULT 0,
	IsRotatable Bool NOT NULL DEFAULT 1,
	Name Varchar(255),
	Description Varchar(255),
	ThumbnailFileLocation Varchar(255),
	...
	CanViewOriginal Bool NOT NULL DEFAULT 0,
...
Create table AssetView (
	...
	UserId Bigint,
	SessionLogId Bigint) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetApproval (
	...
	IsHighResApproval Bool NOT NULL DEFAULT 0,
 Primary Key (AssetId,UserId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table OrgUnit (
	...
	RootDescriptiveCategoryId Bigint,
	DiskQuotaMb Int,
...
Create table OrgUnitGroup (
 ...
 Primary Key (UserGroupId,OrgUnitId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table ABOrder (
	...
	UserNotes Mediumtext,
	PrefersOfflinePayment Bool NOT NULL DEFAULT 0,
	ShippingCost Int,
	BasketCost Int,
	DiscountPercentage Int,
	PSPUserId Varchar(255),
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetPurchaseLog (
	...
	Price Int,
	ShippingCost Int,
 Primary Key (ABOrderId,AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table UsageTypeFormat (
	...
	ImageWidth Int,
	ImageHeight Int,
	ScaleUp Bool DEFAULT 0,
	Density Int,
	JpegQuality Int,
	PreserveFormatList Varchar(255),
	ApplyStrip Bool,
	OmitIfLowerRes Bool DEFAULT 0,
	CropToFit Bool DEFAULT 0,
	ConvertToColorSpaceId Bigint,
	Watermark Bool DEFAULT 0,
	AllowMasking Bool NOT NULL DEFAULT 1,
	PresetMaskId Int,
	PresetMaskColourId Int,
	FillBackground Bool DEFAULT 0,
	BackgroundColour Varchar(100),
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table SendEmailDateRule (
	...
	Enabled Bool NOT NULL DEFAULT 0,
	EmailAssetDownloaders Bool NOT NULL DEFAULT 0,
	EmailAssetUploader Bool NOT NULL DEFAULT 0,
	EmailAdminUsers Bool NOT NULL DEFAULT 1,
	EmailLastApprover Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table GroupEmailRule (
	...
	UserGroupId Bigint NOT NULL,
 Primary Key (RuleId,UserGroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table GroupUsageExclusion (
	...
	UserGroupId Bigint NOT NULL,
 Primary Key (UsageTypeId,UserGroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table ListItem (
 ...
 Primary Key (Identifier,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table GroupInSubscriptionModel (
	SubscriptionModelId Bigint NOT NULL,
	UserGroupId Bigint NOT NULL,
 Primary Key (SubscriptionModelId,UserGroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TaxValue (
	...
	Percent Float(9,3),
	ZeroIfTaxNumberGiven Bool NOT NULL,
 Primary Key (TaxTypeId,TaxRegionId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table CountryInTaxRegion (
 ...
 Primary Key (TaxRegionId,CountryId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table SubscriptionModelUpgrade (
	...
	Price Int,
 Primary Key (FromId,ToId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table VideoAsset (
	...
	Height Int,
	PAR Float(9,3),
	PreviewClipBeingGenerated Bool NOT NULL,
	hasFLVMetaData Bool NOT NULL DEFAULT 0,
 Primary Key (AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table SortAttribute (
	...
	Sequence Int,
	Type Int,
	Reverse Bool DEFAULT 0) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table PriceBandUsage (
 ...
 Primary Key (UsageTypeId,PriceBandId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table ShippingCost (
 ...
 Primary Key (TaxRegionId,PriceBandId,QuantityRangeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetBoxPriceBand (
 ...
 Primary Key (AssetBoxId,AssetId,PriceBandId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetPurchasePriceBand (
	...
	Cost Int,
	ShippingCost Int,
 Primary Key (PriceBandId,ABOrderId,AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table FeaturedAssetInBrand (
	...
	AssetId Bigint NOT NULL,
 Primary Key (BrandId,AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table GroupIsRole (
 ...
 Primary Key (UserGroupId,RoleId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table EmailTemplate (
	...
	Body Mediumtext,
	Hidden Bool DEFAULT 0,
	IsEnabled Bool NOT NULL DEFAULT 1) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table DisplayAttribute (
	...
	ShowOnChild Bool NOT NULL DEFAULT 0,
 Primary Key (DisplayAttributeGroupId,AttributeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetBoxShare (
	...
	Alias Varchar(255),
 Primary Key (AssetBoxId,UserId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table EmbeddedDataMapping (
	...
	DataDelim Varchar(50),
	Sequence Int,
	IsBinary Bool DEFAULT 0,
 Primary Key (EmbeddedDataValueId,AttributeId,MappingDirectionId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table ScheduledReportGroup (
 ...
 Primary Key (ReportId,GroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table UserInMarketingGroup (
	...
	UserId Bigint NOT NULL,
 Primary Key (MarketingGroupId,UserId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedAttribute (
	...
	DisplayName Varchar(255),
	InputMask Varchar(250),
 Primary Key (AttributeId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedCategory (
	...
	Description Mediumtext,
	Summary Varchar(255),
 Primary Key (CategoryId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedUsageType (
	...
	Description Varchar(255),
	Message Text,
 Primary Key (UsageTypeId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedUsageTypeFormat (
	...
	LanguageId Bigint NOT NULL,
	Description Varchar(200),
 Primary Key (UsageTypeFormatId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedFilter (
	...
	LanguageId Bigint NOT NULL,
	Name Varchar(200),
 Primary Key (FilterId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table CustomField (
	...
	OrgUnitId Bigint,
	SequenceNumber Int NOT NULL DEFAULT 999,
	IsSubtype Bool NOT NULL DEFAULT 0,
	LdapProperty Varchar(255),
	ShowOnProfile Bool NOT NULL DEFAULT 1,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table SavedSearch (
	...
	IsRssFeed Bool NOT NULL DEFAULT 0,
	IsBuilderSearch Bool NOT NULL DEFAULT 0,
	IsDescending Bool NOT NULL DEFAULT 0,
	SortAttributeId Bigint,
	Promoted Bool NOT NULL DEFAULT 0,
	AvailableToAll Bool NOT NULL DEFAULT 0,
	Featured Bool DEFAULT 0,
	SearchImage Varchar(250),
	NewAssetAlert Bool NOT NULL DEFAULT 0,
...
Create table TranslatedMarketingGroup (
	...
	Name Varchar(60),
	Description Varchar(255),
 Primary Key (MarketingGroupId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedCommercialOption (
	...
	Description Mediumtext,
	Terms Mediumtext,
 Primary Key (LanguageId,CommercialOptionId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedPriceBandType (
	...
	PriceBandTypeId Bigint NOT NULL,
	Name Varchar(255),
 Primary Key (LanguageId,PriceBandTypeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedOrderStatus (
	...
	LanguageId Bigint NOT NULL,
	Name Varchar(255),
 Primary Key (OrderStatusId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedPriceBand (
	...
	Name Varchar(255),
	Description Varchar(255),
 Primary Key (PriceBandId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedSubscriptionModel (
	...
	LanguageId Bigint NOT NULL,
	Description Varchar(250),
 Primary Key (SubscriptionModelId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedTaxRegion (
	...
	LanguageId Bigint NOT NULL,
	Name Varchar(255),
 Primary Key (TaxRegionId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table AssetInMarketingEmail (
	MarketingEmailId Bigint NOT NULL,
	AssetId Bigint NOT NULL,
 Primary Key (MarketingEmailId,AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedMarketingEmail (
	...
	Name Varchar(255),
	Introduction Mediumtext,
 Primary Key (MarketingEmailId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedTaxType (
	...
	TaxTypeId Bigint NOT NULL,
	Name Varchar(200),
 Primary Key (LanguageId,TaxTypeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedCustomField (
	...
	CustomFieldId Bigint NOT NULL,
	FieldName Varchar(100),
 Primary Key (LanguageId,CustomFieldId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetEntityAttribute (
	...
	AttributeId Bigint NOT NULL,
	IsVisibleOnAdd Bool NOT NULL DEFAULT 1,
	ValueIfNotVisible Mediumtext,
 Primary Key (AssetEntityId,AttributeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetEntity (
	...
	IsQuickSearchable Bool NOT NULL DEFAULT 0,
	IncludedFileFormats Varchar(255),
	ExcludedFileFormats Varchar(255),
	SequenceNumber Int,
	MustHaveParent Bool NOT NULL DEFAULT 0,
	ThumbnailFilename Varchar(100),
	CanCopyAssets Bool NOT NULL DEFAULT 0,
	DefaultCategoryId Bigint,
	OnlyAllowDefaultCategory Bool NOT NULL DEFAULT 0,
	RootCategoryId Bigint,
	UnrestAgreementId Bigint,
	RestAgreementId Bigint,
	ShowAttributeLabels Bool NOT NULL DEFAULT 1,
	TermForSibling Varchar(100),
	CanDownloadChildren Bool NOT NULL DEFAULT 0,
	MatchOnAttributeId Bigint,
	ShowOnDescendantCategories Bool NOT NULL DEFAULT 0,
	IsCategoryExtension Bool NOT NULL DEFAULT 0,
	IsArticle Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AllowableEntityRelationship (
	...
	DefaultRelationshipCategoryId Bigint,
	RelationshipTypeId Bigint NOT NULL,
	RelationshipDescriptionLabel Varchar(255),
 Primary Key (AssetEntityId,RelatesToAssetEntityId,RelationshipTypeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AllowableEntityAssetType (
	AssetEntityId Bigint NOT NULL,
	AssetTypeId Bigint NOT NULL,
 Primary Key (AssetEntityId,AssetTypeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedAssetEntity (
	...
	TermForSibling Varchar(200),
 Primary Key (AssetEntityId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table FilterInGroup (
	FilterId Bigint NOT NULL,
	GroupId Bigint NOT NULL,
 Primary Key (FilterId,GroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedAgreement (
	...
	Title Varchar(255),
	Body Mediumtext,
 Primary Key (AgreementId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetAgreement (
	...
	IsCurrent Bool) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table OrgUnitForAgreement (
	AgreementId Bigint NOT NULL,
	OrgUnitId Bigint NOT NULL) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedNewsItem (
	...
	Title Varchar(255),
	Content Mediumtext,
 Primary Key (LanguageId,NewsItemId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table WorkflowInfo (
	...
	WorkflowableEntityId Bigint NOT NULL,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table StorageDevice (
	...
	UsedLocalSpaceInBytes Bigint NOT NULL DEFAULT 0,
	AuthenticationName Varchar(255),
	AuthenticationKey Varchar(255),
	HttpBaseUrl Varchar(255),
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table GroupFilterExclusion (
	FilterId Bigint NOT NULL,
	UserGroupId Bigint NOT NULL,
 Primary Key (FilterId,UserGroupId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table FilterForCategory (
	...
	CategoryId Bigint NOT NULL,
	SequenceNumber Int,
 Primary Key (FilterId,CategoryId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetListAttributeValue (
 ...
 Primary Key (AssetId,ListAttributeValueId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedListAttributeValue (
	...
	Value Varchar(255),
	AdditionalValue Mediumtext,
 Primary Key (ListAttributeValueId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedAssetAttributeValues (
	...
	keywords Mediumtext,
	sensitivitynotes Mediumtext,
 Primary Key (AssetId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table FilterAssetAttributeValue (
 ...
 Primary Key (AttributeId,FilterId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table FilterListAttributeValue (
	FilterId Bigint NOT NULL,
	ListAttributeValueId Bigint NOT NULL,
 Primary Key (FilterId,ListAttributeValueId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table LastAttributeValue (
	AttributeId Bigint NOT NULL,
	NumberValue Bigint,
 Primary Key (AttributeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table RepurposedSlideshow (
	DisplayTime Int,
	SlideShowTypeId Bigint NOT NULL DEFAULT 1,
	InfoBar Bool,
	RepurposedVersionId Bigint NOT NULL,
	MaintainAspectRatio Bool DEFAULT 1,
	IncludeLabels Bool NOT NULL DEFAULT 0,
	CaptionIds Varchar(255),
	JpgConversionQuality Int,
	LanguageCode Varchar(20),
	ImageHeight Int,
	ImageWidth Int,
	Description Varchar(255),
	ShowOnHomepage Bool NOT NULL DEFAULT 0,
	IsDefaultOnHomepage Bool NOT NULL DEFAULT 0,
	SequenceNumber Int,
	SearchCriteriaId Bigint,
	TextRtl Bool DEFAULT 1,
 Primary Key (RepurposedVersionId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table RepurposedAsset (
	...
	AssetId Bigint NOT NULL,
	PreviewFileLocation Varchar(255),
	RepurposedVersionId Bigint NOT NULL,
	Regenerable Bool NOT NULL DEFAULT 0,
 Primary Key (RepurposedVersionId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table SecondaryDownloadUsageType (
	...
	UsageTypeId Bigint NOT NULL,
	OriginalDescription Varchar(255),
 Primary Key (AssetUseId,UsageTypeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AttributeInInDesignDocument (
	...
	AttributeId Bigint NOT NULL,
 Primary Key (InDesignDocumentId,AttributeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table InDesignDocument (
	Id Bigint NOT NULL AUTO_INCREMENT,
	InDesignPDFQualityId Int NOT NULL,
	FileLocation Varchar(255) NOT NULL,
	OriginalFilename Varchar(255) NOT NULL,
	FileSizeInBytes Bigint NOT NULL,
	NumSymbols Int NOT NULL,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table InDesignAssetEntity (
 ...
 Primary Key (AssetEntityId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table EntityRelationshipDescription (
 ...
 Primary Key (AssetEntityId,RelationshipTypeId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedERDescription (
	...
	ToName Varchar(100),
	ToNamePlural Varchar(100),
 Primary Key (AssetEntityId,RelationshipTypeId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table OrgUnitContent (
 ...
 Primary Key (OrgUnitId,ContentListItemIdentifier)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table PublishAction (
	...
	AutoUnpublish Bool NOT NULL DEFAULT 0,
	FileTransferType Varchar(20),
	ServerName Varchar(255),
	Username Varchar(255),
	Password Varchar(255),
	UsageTypeId Bigint,
	AttributeId Bigint,
	LastPublished Bigint NOT NULL DEFAULT 0,
	PortNumber Bigint NOT NULL DEFAULT 0,
	SearchCriteriaId Bigint NOT NULL,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table Job (
	...
	DateCreated Datetime NOT NULL,
	DateStarted Datetime COMMENT 'The date that the job started running',
...
Create table TranslatedAudioDownloadOption (
	AudioDownloadOptionId Bigint NOT NULL,
	LanguageId Bigint NOT NULL,
	Label Varchar(255),
 Primary Key (AudioDownloadOptionId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table InDesignLinkedResource (
	AssetId Bigint NOT NULL,
	LinkedAssetId Bigint NOT NULL,
 Primary Key (AssetId,LinkedAssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table PublishingLog (
	Id Bigint NOT NULL AUTO_INCREMENT,
	PublishActionId Bigint NOT NULL,
	AssetId Bigint NOT NULL,
...
Create table PublishedAsset (
	AssetId Bigint NOT NULL,
	PublishActionId Bigint NOT NULL,
 Primary Key (AssetId,PublishActionId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table PublishedAssetFile (
	AssetId Bigint NOT NULL,
	PublishActionId Bigint NOT NULL,
	RelativePath Varchar(255) NOT NULL) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;

Create table UserEditLanguage (
	UserId Bigint NOT NULL,
	LanguageId Bigint NOT NULL,
 Primary Key (UserId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table TranslatedAssetEntityAttribute (
	...
	LanguageId Bigint NOT NULL,
	ValueIfNotVisible Mediumtext,
 Primary Key (AssetEntityId,AttributeId,LanguageId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Alter table AssetBoxAsset add Constraint Relationship6 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table CM_ItemInCategory add Index IX_Relationship8 (ItemId);
Alter table CM_ItemInCategory add Constraint Relationship8 Foreign Key (ItemId) references Asset (Id) on delete  restrict on update  restrict;
Alter table ImageAsset add Constraint Relationship29 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetUse add Index IX_Relationship49 (AssetId);
Alter table AssetUse add Constraint Relationship49 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetApproval add Index IX_Relationship66 (AssetId);
Alter table AssetApproval add Constraint Relationship66 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetView add Index IX_Relationship77 (AssetId);
Alter table AssetView add Constraint Relationship77 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table RelatedAsset add Index IX_Relationship95 (ParentId);
Alter table RelatedAsset add Constraint Relationship95 Foreign Key (ParentId) references Asset (Id) on delete  restrict on update  restrict;
Alter table RelatedAsset add Index IX_Relationship96 (ChildId);
Alter table RelatedAsset add Constraint Relationship96 Foreign Key (ChildId) references Asset (Id) on delete  restrict on update  restrict;
Alter table PromotedAsset add Constraint Relationship104 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table VideoAsset add Constraint Relationship123 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table FeaturedAsset add Constraint FeaturedAsset_Asset_FK Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetBoxPriceBand add Index IX_Relationship135 (AssetId);
Alter table AssetBoxPriceBand add Constraint Relationship135 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table FeaturedAssetInBrand add Index IX_Relationship150 (AssetId);
Alter table FeaturedAssetInBrand add Constraint Relationship150 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AudioAsset add Constraint Relationship151 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetInMarketingEmail add Index IX_Relationship214 (AssetId);
Alter table AssetInMarketingEmail add Constraint Relationship214 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table Asset add Index IX_Relationship219 (CurrentVersionId);
Alter table Asset add Constraint Relationship219 Foreign Key (CurrentVersionId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetChangeLog add Index IX_Relationship241 (AssetId);
Alter table AssetChangeLog add Constraint Relationship241 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetAgreement add Index IX_Relationship273 (AssetId);
Alter table AssetAgreement add Constraint Relationship273 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetRating add Index IX_Relationship278 (AssetId);
Alter table AssetRating add Constraint Relationship278 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
...
Alter table AssetListAttributeValue add Index IX_ALAV_Asset_FK (AssetId);
Alter table AssetListAttributeValue add Constraint ALAV_Asset_FK Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table TranslatedAssetAttributeValues add Index IX_TAAV_Asset_FK (AssetId);
Alter table TranslatedAssetAttributeValues add Constraint TAAV_Asset_FK Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table RepurposedAsset add Index IX_RepurposedAsset_Asset_FK (AssetId);
Alter table RepurposedAsset add Constraint RepurposedAsset_Asset_FK Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
...
Alter table Job add Constraint JobContext_Asset_FK Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
...
Alter table InDesignLinkedResource add Constraint InDLinked_Asset_Doc_FK Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table InDesignLinkedResource add Constraint InDLinked_Asset_Asset_FK Foreign Key (LinkedAssetId) references Asset (Id) on delete  restrict on update  restrict;
Alter table AssetBoxAsset add Index IX_Relationship5 (AssetBoxId);
Alter table AssetBoxAsset add Constraint Relationship5 Foreign Key (AssetBoxId) references AssetBox (Id) on delete  restrict on update  restrict;
Alter table AssetBoxPriceBand add Index IX_Relationship134 (AssetBoxId);
Alter table AssetBoxPriceBand add Constraint Relationship134 Foreign Key (AssetBoxId) references AssetBox (Id) on delete  restrict on update  restrict;
Alter table AssetBoxShare add Index IX_Relationship158 (AssetBoxId);
Alter table AssetBoxShare add Constraint Relationship158 Foreign Key (AssetBoxId) references AssetBox (Id) on delete  restrict on update  restrict;
Alter table Asset add Index IX_Asset_User_Added_FK (AddedByUserId);
Alter table Asset add Constraint Asset_User_Added_FK Foreign Key (AddedByUserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table UserInGroup add Index IX_Relationship47 (UserId);
Alter table UserInGroup add Constraint Relationship47 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetUse add Index IX_Relationship51 (UserId);
Alter table AssetUse add Constraint Relationship51 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetBox add Index IX_Relationship52 (UserId);
Alter table AssetBox add Constraint Relationship52 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetView add Index IX_Relationship63 (UserId);
Alter table AssetView add Constraint Relationship63 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetApproval add Index IX_Relationship67 (UserId);
Alter table AssetApproval add Constraint Relationship67 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table Asset add Index IX_Asset_User_Modified_FK (LastModifiedByUserId);
Alter table Asset add Constraint Asset_User_Modified_FK Foreign Key (LastModifiedByUserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table ABOrder add Index IX_Relationship78 (UserId);
Alter table ABOrder add Constraint Relationship78 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table Subscription add Index IX_Relationship120 (UserId);
Alter table Subscription add Constraint Relationship120 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetBoxShare add Index IX_Relationship159 (UserId);
Alter table AssetBoxShare add Constraint Relationship159 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetBoxAsset add Index IX_Relationship164 (AddedByUserId);
Alter table AssetBoxAsset add Constraint Relationship164 Foreign Key (AddedByUserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table UserInMarketingGroup add Index IX_Relationship172 (UserId);
Alter table UserInMarketingGroup add Constraint Relationship172 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetBankUser add Index IX_Relationship187 (LastModifiedById);
Alter table AssetBankUser add Constraint Relationship187 Foreign Key (LastModifiedById) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table SavedSearch add Index IX_Relationship195 (UserId);
Alter table SavedSearch add Constraint Relationship195 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table SessionLog add Index IX_Relationship243 (UserId);
Alter table SessionLog add Constraint Relationship243 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table Filter add Index IX_Relationship259 (UserId);
Alter table Filter add Constraint Relationship259 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetRating add Index IX_Relationship279 (UserId);
Alter table AssetRating add Constraint Relationship279 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table WorkflowAudit add Index IX_Relationship284 (UserId);
Alter table WorkflowAudit add Constraint Relationship284 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table AssetBankUser add Index IX_Relationship285 (InvitedByUserId);
Alter table AssetBankUser add Constraint Relationship285 Foreign Key (InvitedByUserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table RepurposedVersion add Index IX_Relationship310 (CreatedByUserId);
Alter table RepurposedVersion add Constraint Relationship310 Foreign Key (CreatedByUserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
...
Alter table UserEditLanguage add Index IX_User_UserEditLang_FK (UserId);
Alter table UserEditLanguage add Constraint User_UserEditLang_FK Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
Alter table CM_ItemInCategory add Index IX_Relationship9 (CategoryId);
Alter table CM_ItemInCategory add Constraint Relationship9 Foreign Key (CategoryId) references CM_Category (Id) on delete  restrict on update  restrict;
Alter table CM_Category add Index IX_Relationship10 (ParentId);
Alter table CM_Category add Constraint Relationship10 Foreign Key (ParentId) references CM_Category (Id) on delete  restrict on update  restrict;
Alter table CategoryVisibleToGroup add Index IX_Relationship35 (CategoryId);
Alter table CategoryVisibleToGroup add Constraint Relationship35 Foreign Key (CategoryId) references CM_Category (Id) on delete  restrict on update  restrict;
Alter table OrgUnit add Constraint Relationship76 Foreign Key (RootOrgUnitCategoryId) references CM_Category (Id) on delete  restrict on update  restrict;
Alter table TranslatedCategory add Index IX_Relationship177 (CategoryId);
Alter table TranslatedCategory add Constraint Relationship177 Foreign Key (CategoryId) references CM_Category (Id) on delete  restrict on update  restrict;
Alter table FilterForCategory add Index IX_Relationship290 (CategoryId);
Alter table FilterForCategory add Constraint Relationship290 Foreign Key (CategoryId) references CM_Category (Id) on delete  restrict on update  restrict;
...
Alter table AssetEntity add Index IX_AssetEntity_Cat_Root_FK (RootCategoryId);
Alter table AssetEntity add Constraint AssetEntity_Cat_Root_FK Foreign Key (RootCategoryId) references CM_Category (Id) on delete  restrict on update  restrict;
Alter table GroupAttributeExclusion add Index IX_Relationship40 (AttributeId);
Alter table GroupAttributeExclusion add Constraint Relationship40 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table AttributeVisibleToGroup add Index IX_Relationship45 (AttributeId);
Alter table AttributeVisibleToGroup add Constraint Relationship45 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table ChangeAttributeValueDateRule add Index IX_Relationship86 (ChangeAttributeId);
Alter table ChangeAttributeValueDateRule add Constraint Relationship86 Foreign Key (ChangeAttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table ChangeAttributeValueDateRule add Index IX_Relationship89 (AttributeId);
Alter table ChangeAttributeValueDateRule add Constraint Relationship89 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table SendEmailDateRule add Index IX_Relationship90 (AttributeId);
Alter table SendEmailDateRule add Constraint Relationship90 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table SortAttribute add Index IX_Relationship126 (AttributeId);
Alter table SortAttribute add Constraint Relationship126 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table DisplayAttribute add Index IX_DA_Attribute_FK (AttributeId);
Alter table DisplayAttribute add Constraint DA_Attribute_FK Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table EmbeddedDataMapping add Index IX_Relationship163 (AttributeId);
Alter table EmbeddedDataMapping add Constraint Relationship163 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table TranslatedAttribute add Index IX_Relationship173 (AttributeId);
Alter table TranslatedAttribute add Constraint Relationship173 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table AssetEntityAttribute add Index IX_Relationship253 (AttributeId);
Alter table AssetEntityAttribute add Constraint Relationship253 Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table AssetEntity add Index IX_Relationship292 (MatchOnAttributeId);
Alter table AssetEntity add Constraint Relationship292 Foreign Key (MatchOnAttributeId) references Attribute (Id) on delete  restrict on update  restrict;
Alter table ListAttributeValue add Index IX_LAV_Attribute_FK (AttributeId);
Alter table ListAttributeValue add Constraint LAV_Attribute_FK Foreign Key (AttributeId) references Attribute (Id) on delete  restrict on update  restrict;
...
Alter table CM_Category add Constraint Relationship7 Foreign Key (CategoryTypeId) references CM_CategoryType (Id) on delete  restrict on update  restrict;
Alter table CategoryVisibleToGroup add Index IX_Relationship34 (UserGroupId);
Alter table CategoryVisibleToGroup add Constraint Relationship34 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table GroupAttributeExclusion add Index IX_Relationship41 (UserGroupId);
Alter table GroupAttributeExclusion add Constraint Relationship41 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table AttributeVisibleToGroup add Index IX_Relationship44 (UserGroupId);
Alter table AttributeVisibleToGroup add Constraint Relationship44 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table UserInGroup add Index IX_Relationship48 (UserGroupId);
Alter table UserInGroup add Constraint Relationship48 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table OrgUnit add Index IX_Relationship73 (AdminGroupId);
Alter table OrgUnit add Constraint Relationship73 Foreign Key (AdminGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table OrgUnitGroup add Index IX_Relationship75 (UserGroupId);
Alter table OrgUnitGroup add Constraint Relationship75 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table OrgUnit add Index IX_Relationship81 (StandardGroupId);
Alter table OrgUnit add Constraint Relationship81 Foreign Key (StandardGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table GroupEmailRule add Index IX_Relationship88 (UserGroupId);
Alter table GroupEmailRule add Constraint Relationship88 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table GroupUsageExclusion add Index IX_Relationship100 (UserGroupId);
Alter table GroupUsageExclusion add Constraint Relationship100 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table GroupInSubscriptionModel add Index IX_Relationship108 (UserGroupId);
Alter table GroupInSubscriptionModel add Constraint Relationship108 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table GroupIsRole add Index IX_Relationship154 (UserGroupId);
Alter table GroupIsRole add Constraint Relationship154 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table ScheduledReportGroup add Index IX_Relationship167 (GroupId);
Alter table ScheduledReportGroup add Constraint Relationship167 Foreign Key (GroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table GroupFilterExclusion add Index IX_Relationship288 (UserGroupId);
Alter table GroupFilterExclusion add Constraint Relationship288 Foreign Key (UserGroupId) references UserGroup (Id) on delete  restrict on update  restrict;
Alter table Attribute add Index IX_Relationship19 (AttributeTypeId);
Alter table Attribute add Constraint Relationship19 Foreign Key (AttributeTypeId) references AttributeType (Id) on delete  restrict on update  restrict;
Alter table Asset add Index IX_Relationship27 (AssetTypeId);
Alter table Asset add Constraint Relationship27 Foreign Key (AssetTypeId) references AssetType (Id) on delete  restrict on update  restrict;
Alter table FileFormat add Index IX_Relationship58 (AssetTypeId);
Alter table FileFormat add Constraint Relationship58 Foreign Key (AssetTypeId) references AssetType (Id) on delete  restrict on update  restrict;
Alter table UsageType add Index IX_Relationship153 (AssetTypeId);
Alter table UsageType add Constraint Relationship153 Foreign Key (AssetTypeId) references AssetType (Id) on delete  restrict on update  restrict;
Alter table PriceBand add Index IX_Relationship223 (AssetTypeId);
Alter table PriceBand add Constraint Relationship223 Foreign Key (AssetTypeId) references AssetType (Id) on delete  restrict on update  restrict;
Alter table AllowableEntityAssetType add Index IX_Relationship254 (AssetTypeId);
Alter table AllowableEntityAssetType add Constraint Relationship254 Foreign Key (AssetTypeId) references AssetType (Id) on delete  restrict on update  restrict;
Alter table AssetUse add Index IX_Relationship50 (UsageTypeId);
Alter table AssetUse add Constraint Relationship50 Foreign Key (UsageTypeId) references UsageType (Id) on delete  restrict on update  restrict;
Alter table AssetApproval add Index IX_Relationship70 (UsageTypeId);
Alter table AssetApproval add Constraint Relationship70 Foreign Key (UsageTypeId) references UsageType (Id) on delete  restrict on update  restrict;
Alter table UsageTypeFormat add Index IX_Relationship82 (UsageTypeId);
Alter table UsageTypeFormat add Constraint Relationship82 Foreign Key (UsageTypeId) references UsageType (Id) on delete  restrict on update  restrict;
Alter table UsageType add Index IX_Relationship97 (ParentId);
Alter table UsageType add Constraint Relationship97 Foreign Key (ParentId) references UsageType (Id) on delete  restrict on update  restrict;
Alter table GroupUsageExclusion add Index IX_Relationship99 (UsageTypeId);
Alter table GroupUsageExclusion add Constraint Relationship99 Foreign Key (UsageTypeId) references UsageType (Id) on delete  restrict on update  restrict;
Alter table PriceBandUsage add Index IX_Relationship129 (UsageTypeId);
Alter table PriceBandUsage add Constraint Relationship129 Foreign Key (UsageTypeId) references UsageType (Id) on delete  restrict on update  restrict;
Alter table TranslatedUsageType add Index IX_Relationship181 (UsageTypeId);
Alter table TranslatedUsageType add Constraint Relationship181 Foreign Key (UsageTypeId) references UsageType (Id) on delete  restrict on update  restrict;
...
Alter table AssetUse add Constraint Relationship57 Foreign Key (AssetDownloadTypeId) references AssetDownloadType (Id) on delete  restrict on update  restrict;
Alter table Asset add Index IX_Relationship60 (FileFormatId);
Alter table Asset add Constraint Relationship60 Foreign Key (FileFormatId) references FileFormat (Id) on delete  restrict on update  restrict;
Alter table UsageTypeFormat add Index IX_Relationship83 (FormatId);
Alter table UsageTypeFormat add Constraint Relationship83 Foreign Key (FormatId) references FileFormat (Id) on delete  restrict on update  restrict;
Alter table RepurposedAsset add Index IX_RepurposedAsset_FileFormat_FK (FileFormatId);
Alter table RepurposedAsset add Constraint RepurposedAsset_FileFormat_FK Foreign Key (FileFormatId) references FileFormat (Id) on delete  restrict on update  restrict;
...
Alter table AssetApproval add Constraint Relationship68 Foreign Key (ApprovalStatusId) references ApprovalStatus (Id) on delete  restrict on update  restrict;
Alter table OrgUnitGroup add Index IX_Relationship74 (OrgUnitId);
Alter table OrgUnitGroup add Constraint Relationship74 Foreign Key (OrgUnitId) references OrgUnit (Id) on delete  restrict on update  restrict;
Alter table AssetBankUser add Index IX_Relationship101 (RequestedOrgUnitId);
Alter table AssetBankUser add Constraint Relationship101 Foreign Key (RequestedOrgUnitId) references OrgUnit (Id) on delete  restrict on update  restrict;
Alter table OrgUnitForAgreement add Index IX_Relationship275 (OrgUnitId);
Alter table OrgUnitForAgreement add Constraint Relationship275 Foreign Key (OrgUnitId) references OrgUnit (Id) on delete  restrict on update  restrict;
Alter table CustomField add Index IX_Relationship293 (OrgUnitId);
Alter table CustomField add Constraint Relationship293 Foreign Key (OrgUnitId) references OrgUnit (Id) on delete  restrict on update  restrict;
...
Alter table AssetPurchaseLog add Constraint Relationship79 Foreign Key (ABOrderId) references ABOrder (Id) on delete  restrict on update  restrict;
Alter table AssetPurchasePriceBand add Index IX_Relationship140 (ABOrderId,AssetId);
Alter table AssetPurchasePriceBand add Constraint Relationship140 Foreign Key (ABOrderId,AssetId) references AssetPurchaseLog (ABOrderId,AssetId) on delete  restrict on update  restrict;
Alter table TranslatedUsageTypeFormat add Index IX_Relationship183 (UsageTypeFormatId);
Alter table TranslatedUsageTypeFormat add Constraint Relationship183 Foreign Key (UsageTypeFormatId) references UsageTypeFormat (Id) on delete  restrict on update  restrict;
Alter table GroupEmailRule add Index IX_Relationship87 (RuleId);
Alter table GroupEmailRule add Constraint Relationship87 Foreign Key (RuleId) references SendEmailDateRule (Id) on delete  restrict on update  restrict;
Alter table ListItem add Index IX_Relationship102 (ListId);
Alter table ListItem add Constraint Relationship102 Foreign Key (ListId) references List (Id) on delete  restrict on update  restrict;
Alter table AssetBankUser add Index IX_Relationship103 (DivisionId);
Alter table AssetBankUser add Constraint Relationship103 Foreign Key (DivisionId) references Division (Id) on delete  restrict on update  restrict;
Alter table GroupInSubscriptionModel add Index IX_Relationship107 (SubscriptionModelId);
Alter table GroupInSubscriptionModel add Constraint Relationship107 Foreign Key (SubscriptionModelId) references SubscriptionModel (Id) on delete  restrict on update  restrict;
Alter table Subscription add Index IX_Relationship119 (SubscriptionModelId);
Alter table Subscription add Constraint Relationship119 Foreign Key (SubscriptionModelId) references SubscriptionModel (Id) on delete  restrict on update  restrict;
Alter table SubscriptionModelUpgrade add Index IX_Relationship121 (FromId);
Alter table SubscriptionModelUpgrade add Constraint Relationship121 Foreign Key (FromId) references SubscriptionModel (Id) on delete  restrict on update  restrict;
Alter table SubscriptionModelUpgrade add Index IX_Relationship122 (ToId);
Alter table SubscriptionModelUpgrade add Constraint Relationship122 Foreign Key (ToId) references SubscriptionModel (Id) on delete  restrict on update  restrict;
Alter table TranslatedSubscriptionModel add Index IX_Relationship207 (SubscriptionModelId);
Alter table TranslatedSubscriptionModel add Constraint Relationship207 Foreign Key (SubscriptionModelId) references SubscriptionModel (Id) on delete  restrict on update  restrict;
Alter table AssetBankUser add Index IX_Relationship110 (AddressId);
Alter table AssetBankUser add Constraint Relationship110 Foreign Key (AddressId) references Address (Id) on delete  restrict on update  restrict;
Alter table ABOrder add Index IX_Relationship139 (ShippingAddressId);
Alter table ABOrder add Constraint Relationship139 Foreign Key (ShippingAddressId) references Address (Id) on delete  restrict on update  restrict;
Alter table Address add Index IX_Relationship109 (CountryId);
Alter table Address add Constraint Relationship109 Foreign Key (CountryId) references Country (Id) on delete  restrict on update  restrict;
Alter table CountryInTaxRegion add Index IX_Relationship118 (CountryId);
Alter table CountryInTaxRegion add Constraint Relationship118 Foreign Key (CountryId) references Country (Id) on delete  restrict on update  restrict;
Alter table TaxValue add Index IX_Relationship113 (TaxTypeId);
Alter table TaxValue add Constraint Relationship113 Foreign Key (TaxTypeId) references TaxType (Id) on delete  restrict on update  restrict;
Alter table TranslatedTaxType add Index IX_Relationship218 (TaxTypeId);
Alter table TranslatedTaxType add Constraint Relationship218 Foreign Key (TaxTypeId) references TaxType (Id) on delete  restrict on update  restrict;
Alter table TaxValue add Index IX_Relationship115 (TaxRegionId);
Alter table TaxValue add Constraint Relationship115 Foreign Key (TaxRegionId) references TaxRegion (Id) on delete  restrict on update  restrict;
Alter table CountryInTaxRegion add Index IX_Relationship117 (TaxRegionId);
Alter table CountryInTaxRegion add Constraint Relationship117 Foreign Key (TaxRegionId) references TaxRegion (Id) on delete  restrict on update  restrict;
Alter table ShippingCost add Index IX_Relationship131 (TaxRegionId);
Alter table ShippingCost add Constraint Relationship131 Foreign Key (TaxRegionId) references TaxRegion (Id) on delete  restrict on update  restrict;
Alter table TranslatedTaxRegion add Index IX_Relationship206 (TaxRegionId);
Alter table TranslatedTaxRegion add Constraint Relationship206 Foreign Key (TaxRegionId) references TaxRegion (Id) on delete  restrict on update  restrict;
...
Alter table SortAttribute add Constraint Relationship125 Foreign Key (SortAreaId) references SortArea (Id) on delete  restrict on update  restrict;
Alter table PriceBandUsage add Index IX_Relationship130 (PriceBandId);
Alter table PriceBandUsage add Constraint Relationship130 Foreign Key (PriceBandId) references PriceBand (Id) on delete  restrict on update  restrict;
Alter table ShippingCost add Index IX_Relationship132 (PriceBandId);
Alter table ShippingCost add Constraint Relationship132 Foreign Key (PriceBandId) references PriceBand (Id) on delete  restrict on update  restrict;
Alter table AssetBoxPriceBand add Index IX_Relationship136 (PriceBandId);
Alter table AssetBoxPriceBand add Constraint Relationship136 Foreign Key (PriceBandId) references PriceBand (Id) on delete  restrict on update  restrict;
Alter table TranslatedPriceBand add Index IX_Relationship205 (PriceBandId);
Alter table TranslatedPriceBand add Constraint Relationship205 Foreign Key (PriceBandId) references PriceBand (Id) on delete  restrict on update  restrict;
Alter table PriceBand add Index IX_Relationship128 (PriceBandTypeId);
Alter table PriceBand add Constraint Relationship128 Foreign Key (PriceBandTypeId) references PriceBandType (Id) on delete  restrict on update  restrict;
Alter table TranslatedPriceBandType add Index IX_Relationship204 (PriceBandTypeId);
Alter table TranslatedPriceBandType add Constraint Relationship204 Foreign Key (PriceBandTypeId) references PriceBandType (Id) on delete  restrict on update  restrict;
Alter table ShippingCost add Index IX_Relationship133 (QuantityRangeId);
Alter table ShippingCost add Constraint Relationship133 Foreign Key (QuantityRangeId) references QuantityRange (Id) on delete  restrict on update  restrict;
Alter table CommercialOptionPurchase add Index IX_Relationship145 (CommercialOptionId);
Alter table CommercialOptionPurchase add Constraint Relationship145 Foreign Key (CommercialOptionId) references CommercialOption (Id) on delete  restrict on update  restrict;
Alter table TranslatedCommercialOption add Index IX_Relationship202 (CommercialOptionId);
Alter table TranslatedCommercialOption add Constraint Relationship202 Foreign Key (CommercialOptionId) references CommercialOption (Id) on delete  restrict on update  restrict;
Alter table ABOrder add Index IX_Relationship138 (OrderStatusId);
Alter table ABOrder add Constraint Relationship138 Foreign Key (OrderStatusId) references OrderStatus (Id) on delete  restrict on update  restrict;
Alter table TranslatedOrderStatus add Index IX_Relationship208 (OrderStatusId);
Alter table TranslatedOrderStatus add Constraint Relationship208 Foreign Key (OrderStatusId) references OrderStatus (Id) on delete  restrict on update  restrict;
Alter table CommercialOptionPurchase add Constraint Relationship146 Foreign Key (PriceBandId,ABOrderId,AssetId) references AssetPurchasePriceBand (PriceBandId,ABOrderId,AssetId) on delete  restrict on update  restrict;
Alter table OrderStatus add Index IX_Relationship141 (OrderWorkflowId);
Alter table OrderStatus add Constraint Relationship141 Foreign Key (OrderWorkflowId) references OrderWorkflow (Id) on delete  restrict on update  restrict;
Alter table FeaturedAssetInBrand add Index IX_Relationship147 (BrandId);
Alter table FeaturedAssetInBrand add Constraint Relationship147 Foreign Key (BrandId) references Brand (Id) on delete  restrict on update  restrict;
Alter table UserGroup add Index IX_Relationship149 (BrandId);
Alter table UserGroup add Constraint Relationship149 Foreign Key (BrandId) references Brand (Id) on delete  restrict on update  restrict;
Alter table ListItem add Index IX_Relationship152 (ListItemTextTypeId);
Alter table ListItem add Constraint Relationship152 Foreign Key (ListItemTextTypeId) references ListItemTextType (Id) on delete  restrict on update  restrict;
Alter table GroupIsRole add Index IX_Relationship155 (RoleId);
Alter table GroupIsRole add Constraint Relationship155 Foreign Key (RoleId) references Role (Id) on delete  restrict on update  restrict;
Alter table EmailTemplate add Index IX_Relationship156 (LanguageId);
Alter table EmailTemplate add Constraint Relationship156 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedAttribute add Index IX_Relationship174 (LanguageId);
Alter table TranslatedAttribute add Constraint Relationship174 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedCategory add Index IX_Relationship178 (LanguageId);
Alter table TranslatedCategory add Constraint Relationship178 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table ListItem add Index IX_Relationship179 (LanguageId);
Alter table ListItem add Constraint Relationship179 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table AssetBankUser add Index IX_Relationship180 (LanguageId);
Alter table AssetBankUser add Constraint Relationship180 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedUsageType add Index IX_Relationship182 (LanguageId);
Alter table TranslatedUsageType add Constraint Relationship182 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedUsageTypeFormat add Index IX_Relationship184 (LanguageId);
Alter table TranslatedUsageTypeFormat add Constraint Relationship184 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedFilter add Index IX_Relationship186 (LanguageId);
Alter table TranslatedFilter add Constraint Relationship186 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedMarketingGroup add Index IX_Relationship197 (LanguageId);
Alter table TranslatedMarketingGroup add Constraint Relationship197 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedCommercialOption add Index IX_Relationship201 (LanguageId);
Alter table TranslatedCommercialOption add Constraint Relationship201 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedPriceBandType add Index IX_Relationship203 (LanguageId);
Alter table TranslatedPriceBandType add Constraint Relationship203 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedPriceBand add Index IX_Relationship209 (LanguageId);
Alter table TranslatedPriceBand add Constraint Relationship209 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedTaxRegion add Index IX_Relationship210 (LanguageId);
Alter table TranslatedTaxRegion add Constraint Relationship210 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedSubscriptionModel add Index IX_Relationship211 (LanguageId);
Alter table TranslatedSubscriptionModel add Constraint Relationship211 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedOrderStatus add Index IX_Relationship212 (LanguageId);
Alter table TranslatedOrderStatus add Constraint Relationship212 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedMarketingEmail add Index IX_Relationship216 (LanguageId);
Alter table TranslatedMarketingEmail add Constraint Relationship216 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedTaxType add Index IX_Relationship217 (LanguageId);
Alter table TranslatedTaxType add Constraint Relationship217 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedCustomField add Index IX_Relationship231 (LanguageId);
Alter table TranslatedCustomField add Constraint Relationship231 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedAssetEntity add Index IX_Relationship251 (LanguageId);
Alter table TranslatedAssetEntity add Constraint Relationship251 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedAgreement add Index IX_Relationship271 (LanguageId);
Alter table TranslatedAgreement add Constraint Relationship271 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedNewsItem add Index IX_Relationship277 (LanguageId);
Alter table TranslatedNewsItem add Constraint Relationship277 Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedListAttributeValue add Index IX_TLAV_Language_FK (LanguageId);
Alter table TranslatedListAttributeValue add Constraint TLAV_Language_FK Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedAssetAttributeValues add Index IX_TAAV_Language_FK (LanguageId);
Alter table TranslatedAssetAttributeValues add Constraint TAAV_Language_FK Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
...
Alter table TranslatedAudioDownloadOption add Constraint TADO_LanguageId_fk Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table UserEditLanguage add Index IX_Lang_UserEditLang_FK (LanguageId);
Alter table UserEditLanguage add Constraint Lang_UserEditLang_FK Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table TranslatedAssetEntityAttribute add Constraint TranslatedAEA_Language_FK Foreign Key (LanguageId) references Language (Id) on delete  restrict on update  restrict;
Alter table EmbeddedDataMapping add Index IX_Relationship1642 (EmbeddedDataValueId);
Alter table EmbeddedDataMapping add Constraint Relationship1642 Foreign Key (EmbeddedDataValueId) references EmbeddedDataValue (Id) on delete  restrict on update  restrict;
Alter table EmbeddedDataValue add Index IX_Relationship15822 (EmbeddedDataTypeId);
Alter table EmbeddedDataValue add Constraint Relationship15822 Foreign Key (EmbeddedDataTypeId) references EmbeddedDataType (Id) on delete  restrict on update  restrict;
Alter table EmbeddedDataMapping add Index IX_Relationship1652 (MappingDirectionId);
Alter table EmbeddedDataMapping add Constraint Relationship1652 Foreign Key (MappingDirectionId) references MappingDirection (Id) on delete  restrict on update  restrict;
Alter table ScheduledReportGroup add Index IX_Relationship165 (ReportId);
Alter table ScheduledReportGroup add Constraint Relationship165 Foreign Key (ReportId) references ScheduledReport (Id) on delete  restrict on update  restrict;
Alter table TranslatedFilter add Index IX_Relationship185 (FilterId);
Alter table TranslatedFilter add Constraint Relationship185 Foreign Key (FilterId) references Filter (Id) on delete  restrict on update  restrict;
Alter table FilterInGroup add Index IX_Relationship261 (FilterId);
Alter table FilterInGroup add Constraint Relationship261 Foreign Key (FilterId) references Filter (Id) on delete  restrict on update  restrict;
Alter table GroupFilterExclusion add Index IX_Relationship287 (FilterId);
Alter table GroupFilterExclusion add Constraint Relationship287 Foreign Key (FilterId) references Filter (Id) on delete  restrict on update  restrict;
Alter table FilterForCategory add Index IX_Relationship289 (FilterId);
Alter table FilterForCategory add Constraint Relationship289 Foreign Key (FilterId) references Filter (Id) on delete  restrict on update  restrict;
...
Alter table UserInMarketingGroup add Constraint Relationship1662 Foreign Key (MarketingGroupId) references MarketingGroup (Id) on delete  restrict on update  restrict;
Alter table TranslatedMarketingGroup add Index IX_Relationship196 (MarketingGroupId);
Alter table TranslatedMarketingGroup add Constraint Relationship196 Foreign Key (MarketingGroupId) references MarketingGroup (Id) on delete  restrict on update  restrict;
Alter table CustomField add Index IX_Relationship190222 (UsageTypeId);
Alter table CustomField add Constraint Relationship190222 Foreign Key (UsageTypeId) references CustomFieldUsageType (Id) on delete  restrict on update  restrict;
Alter table CustomFieldValue add Index IX_Relationship191222 (CustomFieldId);
Alter table CustomFieldValue add Constraint Relationship191222 Foreign Key (CustomFieldId) references CustomField (Id) on delete  restrict on update  restrict;
Alter table CustomFieldValueMapping add Index IX_Relationship201222 (CustomFieldId);
Alter table CustomFieldValueMapping add Constraint Relationship201222 Foreign Key (CustomFieldId) references CustomField (Id) on delete  restrict on update  restrict;
Alter table TranslatedCustomField add Index IX_Relationship232 (CustomFieldId);
Alter table TranslatedCustomField add Constraint Relationship232 Foreign Key (CustomFieldId) references CustomField (Id) on delete  restrict on update  restrict;
Alter table CustomField add Index IX_Relationship187222 (TypeId);
Alter table CustomField add Constraint Relationship187222 Foreign Key (TypeId) references CustomFieldType (Id) on delete  restrict on update  restrict;
Alter table CustomFieldValueMapping add Index IX_Relationship200222 (ListValue);
Alter table CustomFieldValueMapping add Constraint Relationship200222 Foreign Key (ListValue) references CustomFieldValue (Id) on delete  restrict on update  restrict;
Alter table EmailTemplate add Index IX_Relationship198 (TypeId);
Alter table EmailTemplate add Constraint Relationship198 Foreign Key (TypeId) references EmailTemplateType (Id) on delete  restrict on update  restrict;
Alter table AssetInMarketingEmail add Index IX_Relationship2162 (MarketingEmailId);
Alter table AssetInMarketingEmail add Constraint Relationship2162 Foreign Key (MarketingEmailId) references MarketingEmail (Id) on delete  restrict on update  restrict;
Alter table TranslatedMarketingEmail add Index IX_Relationship215 (MarketingEmailId);
Alter table TranslatedMarketingEmail add Constraint Relationship215 Foreign Key (MarketingEmailId) references MarketingEmail (Id) on delete  restrict on update  restrict;
Alter table AssetChangeLog add Index IX_Relationship229 (LogTypeId);
Alter table AssetChangeLog add Constraint Relationship229 Foreign Key (LogTypeId) references LogType (Id) on delete  restrict on update  restrict;
Alter table AssetUse add Index IX_Relationship237 (SessionLogId);
Alter table AssetUse add Constraint Relationship237 Foreign Key (SessionLogId) references SessionLog (Id) on delete  restrict on update  restrict;
Alter table AssetView add Index IX_Relationship238 (SessionLogId);
Alter table AssetView add Constraint Relationship238 Foreign Key (SessionLogId) references SessionLog (Id) on delete  restrict on update  restrict;
Alter table AssetChangeLog add Index IX_Relationship239 (SessionLogId);
Alter table AssetChangeLog add Constraint Relationship239 Foreign Key (SessionLogId) references SessionLog (Id) on delete  restrict on update  restrict;
Alter table TranslatedAssetEntityAttribute add Constraint TranslatedAEA_AEA_FK Foreign Key (AssetEntityId,AttributeId) references AssetEntityAttribute (AssetEntityId,AttributeId) on delete  restrict on update  restrict;
Alter table AllowableEntityRelationship add Index IX_AssetEntity_AER_2_FK (AssetEntityId);
Alter table AllowableEntityRelationship add Constraint AssetEntity_AER_2_FK Foreign Key (AssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
Alter table AssetEntityAttribute add Index IX_Relationship23522 (AssetEntityId);
Alter table AssetEntityAttribute add Constraint Relationship23522 Foreign Key (AssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
Alter table AllowableEntityAssetType add Index IX_Relationship23822 (AssetEntityId);
Alter table AllowableEntityAssetType add Constraint Relationship23822 Foreign Key (AssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
Alter table TranslatedAssetEntity add Index IX_Relationship2412 (AssetEntityId);
Alter table TranslatedAssetEntity add Constraint Relationship2412 Foreign Key (AssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
Alter table Asset add Index IX_Relationship256 (AssetEntityId);
Alter table Asset add Constraint Relationship256 Foreign Key (AssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
...
Alter table AllowableEntityRelationship add Index IX_AssetEntity_AER_FK (RelatesToAssetEntityId);
Alter table AllowableEntityRelationship add Constraint AssetEntity_AER_FK Foreign Key (RelatesToAssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
Alter table AllowableEntityRelationship add Index IX_RelationshipType_AER_FK (RelationshipTypeId);
Alter table AllowableEntityRelationship add Constraint RelationshipType_AER_FK Foreign Key (RelationshipTypeId) references RelationshipType (Id) on delete  restrict on update  restrict;
Alter table RelatedAsset add Index IX_Relationship255 (RelationshipTypeId);
Alter table RelatedAsset add Constraint Relationship255 Foreign Key (RelationshipTypeId) references RelationshipType (Id) on delete  restrict on update  restrict;
...
Alter table Filter add Constraint Relationship258 Foreign Key (FilterTypeId) references FilterType (Id) on delete  restrict on update  restrict;
Alter table FilterGroup add Index IX_Relationship260 (FilterTypeId);
Alter table FilterGroup add Constraint Relationship260 Foreign Key (FilterTypeId) references FilterType (Id) on delete  restrict on update  restrict;
Alter table FilterInGroup add Index IX_Relationship262 (GroupId);
Alter table FilterInGroup add Constraint Relationship262 Foreign Key (GroupId) references FilterGroup (Id) on delete  restrict on update  restrict;
Alter table ChangeAttributeValueDateRule add Index IX_Relationship266 (ActionOnAssetId);
Alter table ChangeAttributeValueDateRule add Constraint Relationship266 Foreign Key (ActionOnAssetId) references ActionOnAsset (Id) on delete  restrict on update  restrict;
Alter table ListAttributeValue add Index IX_LAV_AOA_FK (ActionOnAssetId);
Alter table ListAttributeValue add Constraint LAV_AOA_FK Foreign Key (ActionOnAssetId) references ActionOnAsset (Id) on delete  restrict on update  restrict;
Alter table TranslatedAgreement add Index IX_Relationship269 (AgreementId);
Alter table TranslatedAgreement add Constraint Relationship269 Foreign Key (AgreementId) references Agreement (Id) on delete  restrict on update  restrict;
Alter table AssetAgreement add Index IX_Relationship272 (AgreementId);
Alter table AssetAgreement add Constraint Relationship272 Foreign Key (AgreementId) references Agreement (Id) on delete  restrict on update  restrict;
Alter table OrgUnitForAgreement add Index IX_Relationship274 (AgreementId);
Alter table OrgUnitForAgreement add Constraint Relationship274 Foreign Key (AgreementId) references Agreement (Id) on delete  restrict on update  restrict;
Alter table TranslatedNewsItem add Index IX_Relationship2702 (NewsItemId);
Alter table TranslatedNewsItem add Constraint Relationship2702 Foreign Key (NewsItemId) references NewsItem (Id) on delete  restrict on update  restrict;
Alter table UsageTypeFormat add Index IX_Relationship286 (ConvertToColorSpaceId);
Alter table UsageTypeFormat add Constraint Relationship286 Foreign Key (ConvertToColorSpaceId) references ColorSpace (Id) on delete  restrict on update  restrict;
Alter table AssetListAttributeValue add Index IX_ALAV_LAV_FK (ListAttributeValueId);
Alter table AssetListAttributeValue add Constraint ALAV_LAV_FK Foreign Key (ListAttributeValueId) references ListAttributeValue (Id) on delete  restrict on update  restrict;
Alter table TranslatedListAttributeValue add Index IX_TLAV_LAV_FK (ListAttributeValueId);
Alter table TranslatedListAttributeValue add Constraint TLAV_LAV_FK Foreign Key (ListAttributeValueId) references ListAttributeValue (Id) on delete  restrict on update  restrict;
...
Alter table PublishingLog add Index IX_PublishingLog_PA_FK (PublishActionId);
Alter table PublishingLog add Constraint PublishingLog_PA_FK Foreign Key (PublishActionId) references PublishAction (Id) on delete  restrict on update  restrict;
Alter table PublishedAsset add Index IX_PublishedAsset_PA_FK (PublishActionId);
Alter table PublishedAsset add Constraint PublishedAsset_PA_FK Foreign Key (PublishActionId) references PublishAction (Id) on delete  restrict on update  restrict;
Alter table DisplayAttribute add Index IX_DA_DAG_FK (DisplayAttributeGroupId);
Alter table DisplayAttribute add Constraint DA_DAG_FK Foreign Key (DisplayAttributeGroupId) references DisplayAttributeGroup (Id) on delete  restrict on update  restrict;
...
Alter table Job add Index IX_InDJob_JobStatus_FK (JobStatusId);
Alter table Job add Constraint InDJob_JobStatus_FK Foreign Key (JobStatusId) references JobStatus (Id) on delete  restrict on update  restrict;
...
Alter table RepurposedSlideshow add Constraint RSlideshow_SlideShowType_FK Foreign Key (SlideShowTypeId) references SlideShowType (Id) on delete  restrict on update  restrict;
...
Alter table TranslatedAudioDownloadOption add Constraint TADO_AudioDownloadOptionId_FK Foreign Key (AudioDownloadOptionId) references AudioDownloadOption (Id) on delete  restrict on update  restrict;
Alter table SavedSearch add Index IX_SavedSearch_SearchCrit_FK (SearchCriteriaId);
Alter table SavedSearch add Constraint SavedSearch_SearchCrit_FK Foreign Key (SearchCriteriaId) references SearchCriteria (Id) on delete  restrict on update  restrict;
Alter table PublishAction add Index IX_PublishAction_SearchCrit_FK (SearchCriteriaId);
Alter table PublishAction add Constraint PublishAction_SearchCrit_FK Foreign Key (SearchCriteriaId) references SearchCriteria (Id) on delete  restrict on update  restrict;
Alter table RepurposedSlideshow add Index IX_RSlideshow_SearchCrit_FK (SearchCriteriaId);
Alter table RepurposedSlideshow add Constraint RSlideshow_SearchCrit_FK Foreign Key (SearchCriteriaId) references SearchCriteria (Id) on delete  restrict on update  restrict;
Alter table PublishedAssetFile add Index IX_PubAssetFile_PubAsset_FK (AssetId,PublishActionId);
Alter table PublishedAssetFile add Constraint PubAssetFile_PubAsset_FK Foreign Key (AssetId,PublishActionId) references PublishedAsset (AssetId,PublishActionId) on delete  restrict on update  restrict;
...
INSERT INTO SystemSetting (Id,Value) VALUES ('StoredChangesWritten','true');
INSERT INTO SystemSetting (Id,Value) VALUES ('SerializedSearchesConverted','true');
INSERT INTO SystemSetting (Id,Value) VALUES ('SearchCriteriaMigrated','true');
INSERT INTO SystemSetting (Id,Value) VALUES ('SlideshowCriteriaMigrated','true');
INSERT INTO SystemSetting (Id,Value) VALUES ('PublishActionCriteriaMigrated','true');
...
INSERT INTO StorageDevice (Id,Name,StorageTypeId,Path,IsRelative,IsLocked,SequenceNumber,FactoryClassName) VALUES (1,'System',1,'files/system',1,0,1,'com.bright.framework.storage.service.FileSystemStorageDeviceFactory');
INSERT INTO StorageDevice (Id,Name,StorageTypeId,Path,IsRelative,IsLocked,SequenceNumber,FactoryClassName) VALUES (2,'Assets',2,'files/assets',1,0,1,'com.bright.framework.storage.service.FileSystemStorageDeviceFactory');
INSERT INTO StorageDevice (Id,Name,StorageTypeId,Path,IsRelative,IsLocked,SequenceNumber,FactoryClassName) VALUES (3,'Thumbnails',3,'files/thumbnails',1,0,1,'com.bright.framework.storage.service.FileSystemStorageDeviceFactory');
...
INSERT INTO Attribute (Id, IsStatic, StaticFieldName, Label, IsMandatory, IsReadOnly, IsKeywordSearchable) VALUES (6, 1, 'originalFilename', 'Original Filename', 0, 1, 1);
...
INSERT INTO Attribute (Id, IsStatic, StaticFieldName, Label, IsMandatory, IsReadOnly) VALUES (18, 1, 'accessLevels', 'Access Levels', 0, 0);
...
INSERT INTO Attribute (Id, AttributeTypeId, IsStatic, Label, ValueColumnName, IsMandatory, NameAttribute, IsKeywordSearchable, MaxSize) VALUES (3, 1, 0, 'Title', 'title', 1, 1, 1, 4000);
INSERT INTO Attribute (Id, AttributeTypeId, IsStatic, Label, ValueColumnName, IsMandatory, DefaultValue, IsKeywordSearchable, Height, MaxSize) VALUES (4, 2, 0, 'Description', 'description', 1, '', 1, 4, 4000);
INSERT INTO Attribute (Id, AttributeTypeId, Label, ValueColumnName, IsKeywordSearchable, IsMandatory, Height, MaxSize) VALUES (5, 2, 'Keywords', 'keywords', 1, 0, 4, 4000);
...
INSERT INTO Attribute (Id, IsStatic, Label, ValueColumnName, IsMandatory, AttributeTypeId, Height, MaxSize) VALUES (301, 0, 'Sensitivity Notes', 'sensitivitynotes', 0, 2, 4, 4000);
-- New rows must have IDs starting from 1000000000 (for explanation see comment near start of this file)
...
INSERT INTO DisplayAttributeGroup (Id, Name, SequenceNumber) VALUES (11, 'Browse Compact View', 11);
INSERT INTO DisplayAttributeGroup (Id, Name, SequenceNumber) VALUES (12, 'Publish Filename', 12);
...
INSERT INTO UserInGroup (UserId, UserGroupId) VALUES (1,1);
...
INSERT INTO LogType (Id, Name) VALUES (7, 'Added to Batch Release');
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Summary, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'homepage-no-featured-image', 1, 'Home Page featured asset placeholder', 'The copy shown on the home page when there is no featured asset set.', '<h3>Featured asset</h3><p>Log in as an admin user and find the asset you want. Click Edit, check &#39;Featured Asset?&#39; and save.</p><p>To change this text go to the Content section in the Admin menu.', 1, 1);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-featured-image-caption', 1, 'Label - Featured Asset Caption', '', 1, 1);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'category-conflict-error-intro', 9, 'Category Conflict Error Intro', '<p>You are unable to edit assets of this type due to org unit restrictions.</p><p>Please contact your IT support team or use the <a href="viewContact">contact page</a>, giving the details below for reference.</p>', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'intro-indesign-make-templated', 1, 'Intro - InDesign - Make Templated', '<p>Make Templated will make this asset revert to using a template document by deleting the asset-specific document that is overriding the template.</p> <p>You can optionally change the asset''s type and template at the same time as making it templated.</p>', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'agreement-checkbox-lightbox', 1, 'Agreement checkbox for lightbox', 'I have read and accept the agreement for each #item#', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'asset-background-edit-in-progress', 1, 'View asset: background edit in progress', '<strong>This #item# is currently being updated and cannot be edited.</strong><br/>If you wish to make changes to this asset please try again in a few minutes.', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'conditions-shared-file', 1, 'Terms and Conditions (Shared Files)', '<h1>Terms and Conditions</h1> <p>Before you download a file, please ensure you have permission to use it, and that you understand its usage terms.</p> <p><span style="color: #888888;">(This text can be changed by an admin user by going to Admin-&gt;Content in the menu.)</span></p>', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tsandcs-shared-file-checkbox', 1, 'Ts and Cs checkbox text for shared file downloads', 'I have read and accept the <a href="../action/viewSharedFileConditionsPopup" target="_blank" onClick="popupConditions(''../action/viewSharedFileConditionsPopup'', 1); return false;" title="View Terms and Conditions in a new window">Terms and Conditions</a>', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'upload-conversion-warning', 1, 'Upload single asset - warning if conversion failed', 'The preview thumbnails could not be generated, either because of a problem with the file or because of an application error. You can go ahead and add the file anyway, in which case it will be added as an #item# of type ''file''. By default a generic icon will be used for the thumbnails, although you may want to use the ''Working file'' field below to upload a JPEG version of your file, which will then be used instead to generate the thumbnails.', 1, 1);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'menu-help', 7, 'Header links - Help', 'Help for this page', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'menu-file-transfer', 7, 'Main menu - File Transfer', 'File Transfer', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'term-for-default-language', 8, 'Term for Default Language', 'English', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-user-receive-alerts', 9, 'Label - Receive Alerts', 'Receive Alerts:', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-user-receive-alerts-note', 9, 'Label - Receive Alerts Note', 'Check this to receive alert emails generated by the system.', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-featured-image', 9, 'Label - Featured Asset?', 'Featured Asset?', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-editable-languages', 9, 'Label - Editable Languages', 'Languages visible when editing assets', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1,'label-download-as-ppt', 9, 'Label - Download as PPT/PPTX', 'Download as PowerPoint Presentation', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-file', 9, 'Label - file', 'File:', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-group-edit', 9, 'Label - Group edit', 'Group edit', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-individual-edit', 9, 'Label - Individual edit', 'Individual edit', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-notify-when-downloaded', 9, 'Label - Notify when downloaded (File Transfer)', 'Notify me when the file is downloaded:', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1,'label-simple-indesign-include-lightbox-contents', 9, 'Label - Include Lightbox contents', 'Include #a-lightbox# contents?', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-agree-to-terms', 9, 'Label - Agree to terms', 'I agree to comply with the <a href="../action/viewConditionsPopup?extra=true" class="help-popup" target="_blank" title="View Terms and Conditions in a new window">Terms and Conditions</a> of the use of #app-name#.', 1, 1);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-all-requests', 10, 'Heading - Pending requests', 'Pending', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-fulfilled-requests', 10, 'Heading - Fulfilled requests', 'Fulfilled', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-request-not-found', 10, 'Heading - Request Not Found', 'Request Not Found', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-rejected-requests', 10, 'Heading - Rejected requests', 'Rejected', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-file-transfer-step-1', 10, 'Heading - File Transfer Step 1', 'File Transfer Step 1: Upload File', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-file-transfer-step-2', 10, 'Heading - File Transfer Step 2', 'File Transfer Step 2: Choose Recipients', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-indesign-linked-assets', 10, 'heading-indesign-linked-assets', 'Assets that ?linkedAssetName? links to', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-indesign-linking-assets', 10, 'heading-indesign-linking-assets', 'InDesign assets with links to ?linkedAssetName?', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-edit-metadata', 10, 'Heading - Edit metadata', 'Edit metadata', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'heading-select-crop-area', 10, 'Heading - Select crop area', 'Select crop area', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'button-select-for-cms', 11, 'Button - Select for CMS', 'Select for CMS', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'button-add-selected-users', 11, 'Button - Add Selected Users', 'Add Selected Users', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-search-again', 12, 'Link - Search again', 'New Search', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-remove-share', 12, 'Link - remove share', 'remove share', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-save-search', 12, 'Link - Save search', 'Save this search', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-copy', 12, 'Link - Copy', 'copy', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1, 'link-revalidate-batch-release', 12, 'Link - Revalidate (batch release)', 'Revalidate', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1, 'link-download-now', 12, 'Link - Download now', 'Download now &raquo;', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-back-to-rejected-requests', 12, 'Link - Back to Rejected Requests', '&laquo; Back to Rejected Requests', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-view-linked-assets', 12, 'link-view-linked-assets', 'View linked images', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-view-linking-assets', 12, 'link-view-linking-assets', 'View linking indds', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-panel-view', 12, 'Link - Panel View', 'Panel View', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-list-view', 12, 'Link - List View', 'List View', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-compact-view', 12, 'Link - Compact View', 'Compact View', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'link-simple-indesign-show-duplicate-assets', 12, 'Link - Show duplicate items', 'Show duplicate #items#', 1, 3);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-current-year', 13, 'Snippet - Most recent year that the code was changed (for copyright message)', '2012', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-text-rtl', 13, 'Snippet - Text right-to-left', 'Display text right-to-left?', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-password-hidden', 13, 'Snippet - Password hidden', 'Password hidden for security reasons', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-include-lightbox-contents', 13, 'Snippet - Include Lightbox contents', 'This will download all the #items# in your  #a-lightbox#  to your working directory for use in the document', 1, 3);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-source-file', 13, 'Snippet - Source file', 'Source file:', 1, 3);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-view-source-file-in', 13, 'Snippet - View source file in', 'View in ?cseEditorName?', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-resume-editing-source-file', 13, 'Snippet - Resume editing source file', 'Resume editing', 1, 3);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-edit-source-file-in', 13, 'Snippet - Edit source file in', 'Edit in ?cseEditorName?', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-source-file-checked-out-to', 13, 'Snippet - Source file already checked out to', 'File checked out to ?forename? ?surname? for editing.', 1, 3);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-bulk-update-skipping-due-to-category-conflict', 13, 'Snippet - Bulk Update Skipping due to category conflict', 'Skipping asset: [0] because of an org unit root category conflict with this asset''s type', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-bulk-update-skipping-background-edit', 13, 'Snippet - Bulk Update Skipping because background edit in progress', 'Skipping asset: [0] because it is being edited in the background', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-bulk-update-extension-asset', 13, 'Snippet - Bulk Update Extension Asset', 'Asset: [0] is an extension asset. The name of the associated category won''t be updated. If the category name needs updating please change it manually from the Admin section.', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-bulk-update-skipping-asset-default-category', 13, 'Snippet - Bulk Update Skipping asset with default category', 'Categories for this asset cannot be updated because the asset type has a default category assigned.', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-no-requests-in-state', 13, 'Snippet - No requests in state', 'Currently there are no requests in this status.', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-no-requests', 13, 'Snippet - No requests', 'You don''t currently have any requests.', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-no-of-requests', 13, 'Snippet - No. of requests', 'You have made ?noOfRequests? requests', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-describe-request', 13, 'Snippet - Describe request', 'Please provide details of the asset you require', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-request-instructions', 13, 'Snippet - Request instructions', 'Please include as much detail as possible, including the desired file format.', 1, 1);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-me', 13, 'Snippet - me (first person singular objective pronoun)', 'me', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-submitted', 13, 'Snippet - Submitted', 'Submitted', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-asset-requested', 13, 'Snippet - Asset Requested', 'Asset Requested', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1, 'snippet-emailed-asset-available', 13, 'Snippet - Emailed asset available', 'The file that was sent to you in an email is available for download.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1, 'snippet-emailed-asset-expired', 13, 'Snippet - Emailed asset expired', 'The file that was sent to you in an email has now expired.<br />If you need to download the file, please contact the person who sent it to you.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-request-not-found', 13, 'Snippet - request not found', 'Sorry, the request could not be found. It is possible that it has been deleted recently', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1, 'snippet-delete-request-confirmation', 13, 'Snippet - Delete Request Confirmation', 'Are you sure you want to delete this request?', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1, 'snippet-indd-make-templated-warning', 13, 'Snippet - Make InDesign Document Templated Warning', 'Making this asset templated will delete this asset''s InDesign document.', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1, 'snippet-change-entity-warning', 13, 'Snippet - Change Asset Entity Warning', 'Any relationships with other assets that are not valid for the new type will be deleted.', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-number-items-shown', 13, 'Snippet - Note about max assets number on approval list', '<strong>Note</strong>: for performance reasons only ?numberAssets? #item#s are shown. More will be shown as you process the #item#s below.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-e-card-sent', 13, 'Snippet - E-card Sent Confirmation', 'Your e-card has been sent to: ?recipientEmail?', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-file-transfer-flashjava-upload-instructions', 13, 'Snippet - Flash/Java Upload Instructions', '<p>First, upload your file using the controls below, then click Next to choose who to send it to.</p>', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-file-transfer-simple-upload-instructions', 13, 'Snippet - Simple Upload Instructions', '<p>Please click &quot;Browse&quot; to locate the file you want to send, and then click &quot;Upload&quot; to upload the file.<br /> Once the file has been uploaded you will be able to enter the email addresses of the people you want to send it to.</p>', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-group-edit', 13, 'Snippet - Group edit', 'Use the same values for each item in the list.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-individual-edit', 13, 'Snippet - Individual edit', 'Allow different values for each item in the list.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-separate-with-semicolon', 13, 'Snippet - Seperate addresses with ;', '(Separate addresses with '';'')', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1,'snippet-simple-indesign-include-lightbox-contents', 13, 'Snippet - Include Lightbox contents', 'This will download all the #items# in your #a-lightbox# to your working directory for use in the InDesign document', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1,'snippet-simple-indesign-resolved-conflicts', 13, 'Snippet - Resolved Conflicts', 'Note: You have already resolved duplicate #items# for this document', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeId) VALUES (1,'snippet-language-specific-overrides', 13, 'Snippet - Language Specific Overrides', 'Language-specific overrides', 1, 3);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-define-languages-profile', 13, 'Snippet - Define which languages in profile', 'You can define which languages are shown on this page in <a href="../action/viewChangeProfile">your profile</a>.', 1, 1);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-default', 13, 'Snippet - default', 'default', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-can-still-edit-x', 1, 'Snippet - of which you can still edit X', '(of which you can still edit ?numEditableItems?)', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-media-email-conversion', 13, 'Snippet - Media email conversion', 'If your browser doesn''t automatically redirect you to the send email page then <a href="?emailUrl?">click here</a>', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'snippet-crop-instructions', 13, 'Snippet - Crop instructions', 'Drag with your mouse to select the crop area. When you have finished, click &quot;Crop &amp; Close&quot;.', 1, 3);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'assetEntityRootCategoryDoesNotExist', 15, 'assetEntityRootCategoryDoesNotExist', 'The root category that you have entered, [0], does not exist or is not a descriptive category.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'assetEntityDefaultCategoryNotDescendantOfRootCategory', 15, 'assetEntityDefaultCategoryNotDescendantOfRootCategory', 'The default category that you have entered is not a descendant of the root category.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'assetEntityDefaultCategoryNotSet', 15, 'assetEntityDefaultCategoryNotSet', 'The default category must be set to a valid category ID in order to only allow assets of this type to be in that category.', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'requestMessageMandatory', 15, 'requestMessageMandatory', 'Please enter the request description.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'fulfillerUserMandatory', 15, 'fulfillerUserMandatory', 'You need to select a Fulfiller user.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'failedValidationNoAssetActionSelected', 15, 'failedValidationNoAssetActionSelected', 'You must select an action to apply from the drop down list', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'sys-error-duplicate-filename', 15, 'System - Error Duplicate Filename', 'The system already contains a file named ''[0]''. Please rename the new file to load and try again.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'failedValidationInDesignERATemplate', 15, 'failedValidationInDesignERATemplate', 'Unable to create empty related assets: One or more of your asset types does not have a valid template selected', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'failedValidationInDesignERAError', 15, 'failedValidationInDesignERAError', 'Unable to create empty related assets: There was an error during the validation of your selected templates', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'missingInDesignLinkedImage', 15, 'missingInDesignLinkedImage', 'Warning: the InDesign document contains a linked image, [0], that could not be found in #app-name#.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'duplicateInDesignLinkedImage', 15, 'duplicateInDesignLinkedImage', 'Warning: the InDesign document contains a linked file, [0], that has multiple matches in #app-name#.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'missingInDesignLinkedResourceOnView', 15, 'missingInDesignLinkedResourceOnView', 'The InDesign document contains linked resources that could not be found in #app-name#:', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'duplicateAssetsInfoOnView', 15, 'duplicateAssetsInfoOnView', '<h3>Duplicate #items#</h3><p>The following linked resources refer to multiple #items# in the system. You will be asked to resolve these conflicts when editing the source file.</p>', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'duplicateAssetsWarningOnEdit', 15, 'duplicateAssetsWarningOnEdit', '<h3>Duplicate #items#</h3><p>This document contains linked resources which refer to more than one possible #item# in the system. Please select which one(s) you want to use:</p>', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'failedValidationInDesignResolveConflicts', 15, 'failedValidationInDesignResolveConflicts', 'Please select which #item# you want to use for each duplicate.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'failedValidationAutoincrementUniqueness', 15, 'failedValidationAutoincrementUniqueness', 'The value already exists for the unique Autoincrement field', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'duplicateAssetsInLightboxWarning', 15, 'duplicateAssetsInLightboxWarning', '<h3>Duplicate #items#</h3><p>Your #a-lightbox# contains #items# which have the same filename.</p><p>Proceeding with the download will result in matching assets being overwritten in the working folder. Please remove the duplicate #items#.</p>', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'title-checked-out-items', 16, 'Title - Checked Out Items', '#company-name# | #heading-checked-out-items#', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'title-create-doc-from-brand-template', 16, 'Title - Create Document From Brand Template', '#company-name# | #heading-create-doc-from-brand-template#', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'title-file-transfer-step-1', 16, 'Title - File Transfer Step 1', '#company-name# | #heading-file-transfer-step-1#', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'title-file-transfer-step-2', 16, 'Title - File Transfer Step 2', '#company-name# | #heading-file-transfer-step-2#', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'title-indesign-linked-assets', 16, 'title-indesign-linked-assets', '#company-name# | InDesign Linked Assets', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'title-indesign-linking-assets', 16, 'title-indesign-linking-assets', '#company-name# | InDesign Linking indds', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'changestooltip-view-workflow-audit', 19, 'Tooltip - View workflow audit popup', 'View asset workflow audit in a new window', 1, 2);
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tooltip-download-as-ppt', 19, 'Tooltip -  Download as PPT', 'Each image will be added to the presentation on a new slide in the order they are shown in your lightbox. If your lightbox contains PowerPoint files then these will be merged into the presentation, although note that PPTX files cannot be merged into a PPT file and vice versa.', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tooltip-disabled-link', 19, 'Tooltip - Disabled Link', 'This option is currently unavailable', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tooltip-view-asset-popup', 19, 'Tooltip - View asset in popup', 'View asset in popup window', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tooltip-switch-compact-view', 19, 'Tooltip - Switch to compact view', 'Switch to compact view', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tooltip-switch-list-view', 19, 'Tooltip - Switch to list view', 'Switch to list view', 1, 2);
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'tooltip-switch-panel-view', 19, 'Tooltip - Switch to panel view', 'Switch to panel view', 1, 2);
...
INSERT INTO Counter (Code, Value) VALUES ('BluebooksECName', 0);
INSERT INTO Counter (Code, Value) VALUES ('CustomListIdentifier', 0);
INSERT INTO Counter (Code, Value) VALUES ('DownloadId', 0);
INSERT INTO Counter (Code, Value) VALUES ('PurchaseId', 0);
INSERT INTO Counter (Code, Value) VALUES ('Test', 0);
...
-- SQLSERVER SET IDENTITY_INSERT JobStatus ON;
...
-- SQLSERVER SET IDENTITY_INSERT JobStatus OFF;
...
-- SQLSERVER SET IDENTITY_INSERT MessageTemplateType ON;
...
-- SQLSERVER SET IDENTITY_INSERT MessageTemplateType OFF;


-- SQLSERVER SET IDENTITY_INSERT MessageStatus ON;
...
-- SQLSERVER SET IDENTITY_INSERT MessageStatus OFF;
...
-- SQLSERVER SET IDENTITY_INSERT SecurityQuestion ON;
...
-- SQLSERVER SET IDENTITY_INSERT SecurityQuestion OFF;

-- SQLSERVER SET IDENTITY_INSERT VideoCommandOption ON;
...
-- SQLSERVER SET IDENTITY_INSERT VideoCommandOption OFF;

-- SQLSERVER SET IDENTITY_INSERT AudioDownloadOption ON;
INSERT INTO AudioDownloadOption (Id, Bitrate, Label, Sequence) VALUES (10001, 96000, 'Low (96 kbps, ~FM Radio Quality)', 3);
INSERT INTO AudioDownloadOption (Id, Bitrate, Label, Sequence) VALUES (10002, 128000, 'Standard (128 kbps, Standard MP3)', 4);
INSERT INTO AudioDownloadOption (Id, Bitrate, Label, Sequence) VALUES (10003, 256000, 'High (256 kbps, Near CD Quality)', 5);
-- SQLSERVER SET IDENTITY_INSERT AudioDownloadOption OFF;
