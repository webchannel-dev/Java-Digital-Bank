...
Create table Asset (
	...
	IsUnsubmitted Char (1) Default 0 NOT NULL ,
	...
	AllowFeedback Char (1) Default 0 NOT NULL ,
	DateSubmitted Date,
	HasNeverBeenApproved Char (1) Default 0 NOT NULL ,
...
Create table AssetBankUser (
	...
	ReactivationPending Char (1) Default 0 NOT NULL ,
	RequestFulfiller Char (1) Default 0 NOT NULL ,
...
Create table CM_Category (
	...
	BrowseAsPanels Char (1) Default 0,
...
Create table Attribute (
	...
	SinglePointOnly Char (1) Default 0 NOT NULL ,
	DateFormatType Smallint Default 0 NOT NULL ,
	AutoCompletePlugin NVarchar2(255),
	EnforceUniqueness Char (1) Default 0 NOT NULL ,
...
Create table UserGroup (
	...
	AutomaticBrandRegister Char (1) Default 0 NOT NULL ,
	AdvancedViewing Char (1) Default 0 NOT NULL ,
...
Create table CategoryVisibleToGroup (
	...
	CanUploadAssets Char (1) Default 0 NOT NULL ,
	CanUploadWithApproval Char (1) Default 0 NOT NULL ,
...
Create table UsageType (
	...
	CanDownloadAsPPT Char (1) Default 0 NOT NULL ,
...
Create table FileFormat (
	...
	IsRotatable Char (1) Default 1 NOT NULL ,
	Name NVarchar2(255),
	Description NVarchar2(255),
	ThumbnailFileLocation NVarchar2(255),
...
Create table UsageTypeFormat (
	...
	FillBackground Char (1) Default 0,
	BackgroundColour NVarchar2(100),
...
Create table SendEmailDateRule (
	...
	EmailAssetUploader Char (1) Default 0 NOT NULL ,
	EmailAdminUsers Char (1) Default 1 NOT NULL ,
	EmailLastApprover Char (1) Default 0 NOT NULL ,
...
Create table VideoAsset (
	...
	hasFLVMetaData Char (1) Default 0 NOT NULL ,
...
Create table CustomField (
	...
	LdapProperty NVarchar2(255),
	ShowOnProfile Char (1) Default 1 NOT NULL ,
...
Create table SavedSearch (
	...
	Promoted Char (1) Default 0 NOT NULL ,
	AvailableToAll Char (1) Default 0 NOT NULL ,
	Featured Char (1) Default 0,
	SearchImage NVarchar2(250),
	NewAssetAlert Char (1) Default 0 NOT NULL ,
	Description NClob,
...
Create table AssetEntityAttribute (
	...
	AttributeId Integer NOT NULL ,
	IsVisibleOnAdd Char (1) Default 1 NOT NULL ,
	ValueIfNotVisible NClob,
...
Create table AssetEntity (
	...
	OnlyAllowDefaultCategory Char (1) Default 0 NOT NULL ,
	...
	IsArticle Char (1) Default 0 NOT NULL ,
...
Create table RepurposedSlideshow (
	...
	MaintainAspectRatio Char (1) Default 1,
	IncludeLabels Char (1) Default 0 NOT NULL ,
	...
	ImageWidth Integer,
	Description NVarchar2(255),
	ShowOnHomepage Char (1) Default 0 NOT NULL ,
	IsDefaultOnHomepage Char (1) Default 0 NOT NULL ,
	SequenceNumber Integer,
	SearchCriteriaId Integer,
	TextRtl Char (1) Default 0,
...
Create table RepurposedAsset (
	...
	AssetId Integer NOT NULL ,
	PreviewFileLocation NVarchar2(255),
	RepurposedVersionId Integer NOT NULL ,
	Regenerable Char (1) Default 0 NOT NULL ,
...
Create table RepurposedVersion (
	...
	HeightMax NVarchar2(5),
	WidthMax NVarchar2(5),
...
Create table PublishAction (
	...
	AutoUnpublish Char (1) Default 0 NOT NULL ,
	FileTransferType NVarchar2(20),
...
Create table Counter (
 ...
 Constraint pk_Counter primary key (Code) 
) 
;
...
Create table AudioDownloadOption (
	...
	Label NVarchar2(255),
	Sequence Integer,
 Constraint pk_AudioDownloadOption primary key (Id) 
) 
;

Create table TranslatedAudioDownloadOption (
	AudioDownloadOptionId Integer NOT NULL ,
	LanguageId Integer NOT NULL ,
	Label NVarchar2(255),
 Constraint pk_TranslatedAudioDownloadOpti primary key (AudioDownloadOptionId,LanguageId) 
) 
;
...
Create table InDesignLinkedResource (
 ...
 Constraint pk_InDesignLinkedResource primary key (AssetId,LinkedAssetId) 
) 
;

Create table SearchCriteria (
	Id Integer NOT NULL ,
	SearchCriteriaFile NVarchar2(255) NOT NULL ,
 Constraint pk_SearchCriteria primary key (Id) 
) 
;

Create table PublishingLog (
	Id Integer NOT NULL ,
	PublishActionId Integer NOT NULL ,
	AssetId Integer NOT NULL ,
	IsPublished Char (1) NOT NULL ,
 Constraint pk_PublishingLog primary key (Id) 
) 
;
...
Create table PublishedAsset (
	AssetId Integer NOT NULL ,
	PublishActionId Integer NOT NULL ,
 Constraint pk_PublishedAsset primary key (AssetId,PublishActionId) 
) 
;
...
Create table PublishedAssetFile (
	AssetId Integer NOT NULL ,
	PublishActionId Integer NOT NULL ,
	RelativePath NVarchar2(255) NOT NULL 
) 
;
...
Create table UserEditLanguage (
	UserId Integer NOT NULL ,
	LanguageId Integer NOT NULL ,
 Constraint pk_UserEditLanguage primary key (UserId,LanguageId) 
) 
;
...
Create table TranslatedAssetEntityAttribute (
	...
	LanguageId Integer NOT NULL ,
	ValueIfNotVisible NClob,
 Constraint pk_TranslatedAssetEntityAttrib primary key (AssetEntityId,AttributeId,LanguageId) 
) 
;
...
;
Alter table Job add Constraint JobContext_Asset_FK foreign key (AssetId) references Asset (Id) 
;
...
;
Create Index IX_InDLinked_Asset_Doc_FK ON InDesignLinkedResource (AssetId)
;
Alter table InDesignLinkedResource add Constraint InDLinked_Asset_Doc_FK foreign key (AssetId) references Asset (Id) 
;
Create Index IX_InDLinked_Asset_Asset_FK ON InDesignLinkedResource (LinkedAssetId)
;
Alter table InDesignLinkedResource add Constraint InDLinked_Asset_Asset_FK foreign key (LinkedAssetId) references Asset (Id) 
;
...
;
Create Index IX_Relationship284 ON WorkflowAudit (UserId)
;
Alter table WorkflowAudit add Constraint Relationship284 foreign key (UserId) references AssetBankUser (Id) 
;
...
;
Alter table CM_ItemInCategory add Constraint IIC_ABU_FK foreign key (LastApprovedByUserId) references AssetBankUser (Id) 
;
...
;
Create Index IX_User_UserEditLang_FK ON UserEditLanguage (UserId)
;
Alter table UserEditLanguage add Constraint User_UserEditLang_FK foreign key (UserId) references AssetBankUser (Id) 
;
...
;
Create Index IX_AssetEntity_Cat_Root_FK ON AssetEntity (RootCategoryId)
;
Alter table AssetEntity add Constraint AssetEntity_Cat_Root_FK foreign key (RootCategoryId) references CM_Category (Id) 
;
...
;
Create Index IX_TADO_LanguageId_fk ON TranslatedAudioDownloadOption (LanguageId)
;
Alter table TranslatedAudioDownloadOption add Constraint TADO_LanguageId_fk foreign key (LanguageId) references Language (Id) 
;
Create Index IX_Lang_UserEditLang_FK ON UserEditLanguage (LanguageId)
;
Alter table UserEditLanguage add Constraint Lang_UserEditLang_FK foreign key (LanguageId) references Language (Id) 
;
Create Index IX_TranslatedAEA_Language_FK ON TranslatedAssetEntityAttribute (LanguageId)
;
Alter table TranslatedAssetEntityAttribute add Constraint TranslatedAEA_Language_FK foreign key (LanguageId) references Language (Id) 
;
...
;
Create Index IX_TranslatedAEA_AEA_FK ON TranslatedAssetEntityAttribute (AssetEntityId,AttributeId)
;
Alter table TranslatedAssetEntityAttribute add Constraint TranslatedAEA_AEA_FK foreign key (AssetEntityId,AttributeId) references AssetEntityAttribute (AssetEntityId,AttributeId) 
;
...
;
Create Index IX_PublishingLog_PA_FK ON PublishingLog (PublishActionId)
;
Alter table PublishingLog add Constraint PublishingLog_PA_FK foreign key (PublishActionId) references PublishAction (Id) 
;
Create Index IX_PublishedAsset_PA_FK ON PublishedAsset (PublishActionId)
;
Alter table PublishedAsset add Constraint PublishedAsset_PA_FK foreign key (PublishActionId) references PublishAction (Id) 
;
...
;
Alter table Job add Constraint InDJob_JobStatus_FK foreign key (JobStatusId) references JobStatus (Id) 
;
...
;
Alter table RepurposedSlideshow add Constraint RSlideshow_SlideShowType_FK foreign key (SlideShowTypeId) references SlideShowType (Id) 
;
...
;
Create Index IX_TADO_AudioDownloadOpt226225 ON TranslatedAudioDownloadOption (AudioDownloadOptionId)
;
Alter table TranslatedAudioDownloadOption add Constraint TADO_AudioDownloadOptionId_FK foreign key (AudioDownloadOptionId) references AudioDownloadOption (Id) 
;
Create Index IX_SavedSearch_SearchCrit_FK ON SavedSearch (SearchCriteriaId)
;
Alter table SavedSearch add Constraint SavedSearch_SearchCrit_FK foreign key (SearchCriteriaId) references SearchCriteria (Id) 
;
Create Index IX_PublishAction_SearchCrit_FK ON PublishAction (SearchCriteriaId)
;
Alter table PublishAction add Constraint PublishAction_SearchCrit_FK foreign key (SearchCriteriaId) references SearchCriteria (Id) 
;
Create Index IX_RSlideshow_SearchCrit_FK ON RepurposedSlideshow (SearchCriteriaId)
;
Alter table RepurposedSlideshow add Constraint RSlideshow_SearchCrit_FK foreign key (SearchCriteriaId) references SearchCriteria (Id) 
;
Create Index IX_PubAssetFile_PubAsset_FK ON PublishedAssetFile (AssetId,PublishActionId)
;
Alter table PublishedAssetFile add Constraint PubAssetFile_PubAsset_FK foreign key (AssetId,PublishActionId) references PublishedAsset (AssetId,PublishActionId) 
;
...
CREATE SEQUENCE JobSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE BatchReleaseSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE MessageSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE SEQUENCE SavedSearchSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;

CREATE SEQUENCE RequestSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE AudioDownloadOptionSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;

CREATE SEQUENCE PublishActionSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE PublishingLogSequence START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;

CREATE SEQUENCE SavedSearchCriteriaSequence START WITH 100 INCREMENT BY 1 NOCACHE NOCYCLE;
