...
<head>
	<title><bean:write name="heading" /></title> 
...
<body>
	...
	<h1 class="underline"><bean:write name="heading" /></h1> 
		...
		<c:if test="${not empty item}">
			...
			<li class="clearfix">
				<a href="../action/viewAsset?id=<bean:write name='asset' property='id'/>" >
					<logic:empty name="asset" property="displayPreviewImageFile.path">
				...
				<div class="details">
					<c:if test="${not empty asset.name && asset.name!=asset.id}"><bean:write name="asset" property="name" /> |</c:if>		
					Id: <bean:write name="asset" property="id" /><br />
					File: <bean:write name="asset" property="fileLocation" /> <br />
					Added: <bean:write name="asset" property="dateAdded"  format="<%= (String)pageContext.getAttribute(\"displayDatetimeFormat\") %>"/>
					by <bean:write name="asset" property="addedByUser.username" /> <br />
					Views: <strong><bean:write name="item" property="numViews" /></strong>, Downloads: <strong><bean:write name="item" property="numDownloads" /></strong><br />
