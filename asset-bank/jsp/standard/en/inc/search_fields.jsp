...
<bright:applicationSetting id="showFileStatusOnSearch" settingName="show-file-status-on-search"/>
	...
	<table class="form" cellspacing="0" cellpadding="0" border="0" summary="Form for advanced search">
		...
		<c:if test="${showFileStatusOnSearch && emptyAssetsEnabled && (userprofile.isAdmin || allowEmptyAssets)}">
			<tr>
				<th>
	...
	<input type="submit" class="button flush floated" id="submitButton" value="${submitButtonText}" /> 
