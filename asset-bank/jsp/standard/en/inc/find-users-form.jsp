	...
	<table cellspacing="0" style="width:auto; margin-bottom:1em;"  class="admin" summary="Form for searching for users">
		...
		<tr>
			<td>
				<input type="text" class="text" id="forename" name="searchCriteria.forename" maxlength="50" size="12" value="<bean:write name='findUsersForm' property='searchCriteria.forename' />">
			</td>
			<td>
				<input type="text" class="text" id="surname" name="searchCriteria.surname" maxlength="50" size="12" value="<bean:write name='findUsersForm' property='searchCriteria.surname' />">
			</td>		
			<td>
				<input type="text" class="text" id="username" name="searchCriteria.username" maxlength="50" size="12" value="<bean:write name='findUsersForm' property='searchCriteria.username' />">			
			</td>
			<td>
				<input type="text" class="text" id="email" name="searchCriteria.emailAddress" maxlength="50" size="12" value="<bean:write name='findUsersForm' property='searchCriteria.emailAddress' />">			
			</td>
			<c:if test="${usersHaveStructuredAddress}">
				<td>
