										...
										<c:when test="${not empty category.imageUrl}">
											<li>
												<table cellspacing="0" cellspadding="0">
													<tr>
														<td style="padding-right:5px"><a href="../action/browseItems?categoryId=<bean:write name='category' property='id' />&amp;categoryTypeId=<bean:write name='category' property='categoryTypeId' />"><img src="../<bean:write name='category' property='imageUrl'/>" width="<bean:write name='catImageWidth'/>" height="<bean:write name='catImageHeight'/>" alt="<bean:write name='category' property='name' />" /></a></td>
