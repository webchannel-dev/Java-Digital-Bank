...
<body id="adminPage" onload="checkForSystemType(<c:out value='${storageDeviceForm.device.typeId}'/>);">
	...
	<c:if test="${storageDeviceForm.device.id>0}">
		<c:if test="${storageDeviceForm.device.isDefault}">
			<p>This is the default storage device, and contains inbuilt files such as icons. This cannot be deleted but may be locked if you would like to create other devices instead.
		</c:if>
