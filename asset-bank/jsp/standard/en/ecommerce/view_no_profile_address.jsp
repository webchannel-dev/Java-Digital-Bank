...
<body id="approvalPage">
	...
	<h1 class="underline"><bright:cmsWrite identifier="e-ecommerce-offline-option-name" filter="false" />Purchase</h1> 

	<bright:cmsWrite identifier="e-profile-incomplete-commercial-purchase" filter="false"/>
