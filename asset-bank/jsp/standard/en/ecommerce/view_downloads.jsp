...
<%-- Always show the date range form --%>
	<div style="padding:1em 0;">
		...
		&nbsp;
		<span class="inlineLabel"><bright:cmsWrite identifier="label-to" filter="false"/></span> <html:text styleClass="small text date" name="assetApprovalListForm" property="endDateString" size="20"/> 
