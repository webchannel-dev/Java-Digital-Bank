				...
				<li id="totals">
						...
						<p class="totals">
							...
							<c:if test="${useShippingCosts && userprofile.assetBox.hasPrint}">
								<bright:cmsWrite identifier="a-lightbox" filter="false"/> <bright:cmsWrite identifier="e-cost" filter="false"/>: <bright:writeMoney name="userprofile" property="assetBox.basketTotal.displayAmount" /><br />
							...
							<strong>
								...
								: <bright:writeMoney name="userprofile" property="assetBox.price.totalAmount.displayAmount" />
							</strong><br />
