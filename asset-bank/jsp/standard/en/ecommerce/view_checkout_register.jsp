...
<body id="checkout">
	...
	<logic:notEmpty name="checkoutForm" property="approvalList">
		...
		<h2><bright:cmsWrite identifier="heading-register" filter="false"/> &raquo;</h2>
		
		<%-- Content managed confirmation text --%>
		<bright:cmsWrite identifier="checkout-register-text" filter="false"/>
		
		<bean:define id="userForm" name="checkoutForm" />
		<html:form action="/registerCheckout" focus="user.forename" method="post">
