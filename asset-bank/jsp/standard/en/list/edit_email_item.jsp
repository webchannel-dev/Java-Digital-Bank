		...
		<table cellspacing="0" class="form" summary="Form for list item details">
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="emailTemplate.addrSubject" size="35" maxlength="250" value="<bean:write name="emailTemplateForm" property="emailTemplate.addrSubject" />" id="addrSubject" />
				</td>
			</tr>			
			<tr>				
