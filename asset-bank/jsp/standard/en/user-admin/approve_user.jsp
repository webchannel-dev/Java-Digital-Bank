...
<head>
	...
	<script type="text/javascript">
		...
		$j(function () {
			...
			// hide email user checkbox by default
			$j('#emailUserRow').hide();

			// show or hide the email user checkbox depending on the selection
			$j('#approve').change(function() {
		 		
				var approveStatus =  $j(this).find(":selected").text();
		...
		<tr>
			...
			<table cellspacing="0" class="form" summary="Form for user permissions" style="margin:0;">
				<tr>
					<th>Approve?:</th>
					<td>
						<select id="approve" name="approved" style="width:100px;" onchange="changedApproveStatus(this);">
				...
				<tr id="emailUserRow">
					...
					<td>
						<html:checkbox style="width: auto;" styleId="email" styleClass="checkbox" name="userForm" property="notifyUser" />
					</td>					
				</tr>
			</table>
