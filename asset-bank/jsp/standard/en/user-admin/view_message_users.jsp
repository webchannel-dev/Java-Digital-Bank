	...
	<form method="post" action="previewMessageUsers" name="messageUsers">
		...
		<fieldset class="bottomborder">
			...
			<tr>
				...
				<td>			
					<input type="text" id="subject" name="messageSubject" value="<bean:write name="messageUsersForm" property="messageSubject" />"/><br/>
				</td>		
			</tr>
			<tr>
				<th>									
		...
		<fieldset class="bottomborder">
			...
			<table cellspacing="0" cellpading="0" class="form">
				<tr>
					...
					<td>			
						<input type="text" id="toUser" name="toUser" value="<bean:write name="messageUsersForm" property="toUser" />"/>
					</td>	
