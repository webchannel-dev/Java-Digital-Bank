		...
		<td class="catPermission<bean:write name='category' property='depth'/>">
			...
			<c:choose>
				<c:when test="${groupForm.accessLevelsExpandable && category.hasRestrictiveChildCategories}">
					<span>
					<a id="expandCat<bean:write name='category' property='id'/>" class="expander" href="javascript:;" onclick="if($j('.ancestorOf<bean:write name='category' property='id'/>').length>0) $j('.ancestorOf<bean:write name='category' property='id'/>').show(); else insertResponseAfter('catRow<bean:write name='category' property='id'/>','viewGroupSubAccessLevelPermissions?categoryId=<bean:write name='category' property='id'/>&id=<bean:write name="groupForm" property="group.id"/>&open=true'); $j('#expandCat<bean:write name='category' property='id'/>').hide(); $j('#collapseCat<bean:write name='category' property='id'/>').show();"><img src="../images/standard/icon/add.gif"  class="expander" /></a><a id="collapseCat<bean:write name='category' property='id'/>"  href="javascript:;" onclick="hideOnAjaxSuccess('ancestorOf<bean:write name='category' property='id'/>','viewGroupSubAccessLevelPermissions?categoryId=<bean:write name='category' property='id'/>&id=<bean:write name="groupForm" property="group.id"/>&open=false'); $j('#expandCat<bean:write name='category' property='id'/>').show(); $j('#collapseCat<bean:write name='category' property='id'/>').hide();" class="hidden"><img src="../images/standard/icon/subtract.gif" class="expander" /></a><bean:write name="category" property="name" />
				</c:when>
				<c:otherwise>
					<span class="empty"><bean:write name="category" property="name" />
				</c:otherwise>
			</c:choose>
