	...
	<c:if test="${useOrganisation}">
		<c:choose>
			<c:when test="${showOrganisationOnProfile}">
				<tr>
					...
					<td colspan="2">
						<input type="text" class="text" id="org" name="user.organisation" size="16" maxlength="200" value="<bean:write name="userForm" property="user.organisation"/>"/>
					</td>													
				</tr>
	...
	<c:if test="${useJobTitle}">																
		<tr>
			...
			<td colspan="2">
				<input type="text" class="text" id="jobtitle" name="user.jobTitle" size="16" maxlength="200" value="<bean:write name="userForm" property="user.jobTitle" />"/>
			</td>													
		</tr>
	</c:if>
