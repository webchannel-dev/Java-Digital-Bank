	...
	<c:if test="${strictValidationSettingAddress}">
		...
		<logic:notEmpty name="labelAddress1">
			<tr>
				<th valign="top"><label for="address1"><bright:write name="labelAddress1" property="body" /></label><c:if test="${strictValidationAddress}"><span class="required">*</span></c:if></th>
				<td colspan="2">
					<input type="text" class="text" id="address1" name="user.homeAddress.addressLine1" size="16" maxlength="200" value="<bean:write name="userForm" property="user.homeAddress.addressLine1" />"/>
				</td>
		...
		<logic:notEmpty name="labelAddress2">			
			<tr>
				<th valign="top"><label for="address2"><bright:write name="labelAddress2" property="body" /></label></th>
				<td colspan="2">
					<input type="text" class="text" id="address2" name="user.homeAddress.addressLine2" size="16" maxlength="200" value="<bean:write name="userForm" property="user.homeAddress.addressLine2" />"/>
				</td>
			</tr>			
		</logic:notEmpty>
		<logic:notEmpty name="labelTown">			
			<tr>
				<th valign="top"><label for="town"><bright:write name="labelTown" property="body" /></label><c:if test="${strictValidationAddress}"><span class="required">*</span></c:if></th>
				<td colspan="2">
					<input type="text" class="text" id="town" name="user.homeAddress.town" size="16" maxlength="100" value="<bean:write name="userForm" property="user.homeAddress.town" />"/>
				</td>
		...
		<logic:notEmpty name="labelCounty">			
			<tr>
				<th valign="top"><label for="county"><bright:write name="labelCounty" property="body" /></label><c:if test="${strictValidationAddressCounty}"><span class="required">*</span></c:if></th>
				<td colspan="2">
					<input type="text" class="text" id="county" name="user.homeAddress.county" size="16" maxlength="100" value="<bean:write name="userForm" property="user.homeAddress.county" />"/>
				</td>
		...
		<logic:notEmpty name="labelPostcode">			
			<tr>
				<th valign="top"><label for="postcode"><bright:write name="labelPostcode" property="body" /></label><c:if test="${strictValidationAddress}"><span class="required">*</span></c:if></th>
				<td colspan="2">
					<input type="text" class="text" id="postcode" name="user.homeAddress.postcode" size="16" maxlength="25" value="<bean:write name="userForm" property="user.homeAddress.postcode" />"/>
				</td>
			</tr>	
		...
		<c:otherwise>
			<c:choose>
				<c:when test="${showAddressOnProfile}">
					<tr>
