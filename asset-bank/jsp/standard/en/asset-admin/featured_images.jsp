...
<head>
	...
	<title><bright:cmsWrite identifier="company-name" filter="false" /> Featured Assets</title> 
...
<body id="adminPage">
	...
	<h1 class="underline">Featured Assets</h1> 
	<%@include file="../public/inc_content_tabs.jsp"%>
	
	<bean:size id="numAssets" name="assetListForm" property="assets" />
	<p>
		There are <bean:write name="numAssets" /> featured assets. 
		View then edit an asset if you want to remove it from the featured set (using the checkbox on the edit asset screen).
	</p>
	...
	<p><a href="../action/manageLists">&laquo; Back</a></p>
