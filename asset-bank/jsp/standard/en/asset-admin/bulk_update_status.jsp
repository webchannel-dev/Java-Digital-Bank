...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
			<div class="confirm">
				...
				<logic:present name="findReplaceReport">
					<ul class="normal">
						<logic:iterate name="findReplaceReport" id="message">
	...
	<c:if test="${bHasBulkUpdateController && !bulkUpdateStatusForm.inProgress && !userprofile.batchUpdateController.delete}"> 
		...
		<p><a href="../action/bulkFindAndReplaceEnterMetadata"><bright:cmsWrite identifier="link-run-another-find-replace-update" filter="false"/></a></p>
