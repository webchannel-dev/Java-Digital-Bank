						...
						<logic:iterate name="bulkUpdateBatchSelectForm" property="listNotUpdated" id="asset" indexId="index">
							...
							<li class="selectable">						
								...
								<div class="detailWrapper">
									...
									<a href="../action/viewAssetInPopup?id=<bean:write name='asset' property='id' />" target="_blank" class="help-popup" title="<bright:cmsWrite identifier="tooltip-view-asset-popup" filter="false"/>"><%@include file="../inc/view_thumbnail.jsp"%></a>					
									<br />		
