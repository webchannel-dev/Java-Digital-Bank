	...
	<form enctype="multipart/form-data" action="<c:out value='${formAction}' />" method="post" class="floated">
		...
		<ul>
			<li>A header row, containing an identifier for each column. The identifiers can be in any order, and can be either 'Name' or 'Description' or a translation header</li><br/>
			...
			<li>Translation headers take the form Lang:[Language code]:Name or Description, for example Lang:fr:Name will add in a translated name for the language with the code fr.</li><br/>
			<ul>
				<li>Note that a language must exist with the given language code.</li><br/>
				<li>Also note that a translated field corresponds to the translation for the child category, meaning it is not possible to enter translations for more than one category per row.</li><br/>
			</ul>
