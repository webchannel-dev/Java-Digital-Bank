...
<body id="browsePage">
					...
					<logic:iterate name="breadcrumbTrail" id="entry" indexId="id">
						<c:choose>
							<c:when test="${id < (trailSize - 1)}">
								<a href="<c:out value='${entry.value}' />"><bean:write name="entry" property="key" /></a>
								&raquo;
							</c:when>
							<c:otherwise>
   ...
   <logic:equal name="browseItemsForm" property="hasErrors" value="true">
	...
	<logic:notEmpty name="browseItemsForm" property="category.description">
		<div class="clearedContainer <c:if test='${ empty browseableCategories }'>underline padded</c:if>">
								...
								<logic:equal name="category" property="isBrowsable" value="true">
									...
									<c:choose>
											...
											<li>
												<table cellspacing="0" cellspadding="0">
													<tr>
														...
														<td><a href="../action/browseItems?categoryId=<bean:write name='category' property='id' />&amp;categoryTypeId=<bean:write name='category' property='categoryTypeId' />&allCats=<bean:write name='allCats'/>"><bean:write name='category' property='name' /></a><logic:present name="itemCount">&nbsp;<bdo dir="ltr">(<bean:write name="itemCount"/>)</bdo></logic:present>												
														</td>
													</tr>
												</table>
											</li>
										...
										<c:otherwise>
											<!-- no image -->
											<li>
												<a href="../action/browseItems?categoryId=<bean:write name='category' property='id' />&amp;categoryTypeId=<bean:write name='category' property='categoryTypeId' />"><bean:write name='category' property='name' /></a><logic:present name="itemCount">&nbsp;<bdo dir="ltr">(<bean:write name="itemCount"/>)</bdo></logic:present>
											</li>
										</c:otherwise>
									</c:choose>		
