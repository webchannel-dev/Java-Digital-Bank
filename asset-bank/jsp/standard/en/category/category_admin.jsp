...
<body id="adminPage">
		...
		<logic:equal name="categoryAdminForm" property="root" value="false">
			<strong>
				...
				<logic:iterate name="categoryAdminForm" property="ancestorCategoryList" id="ancestorCategory"> &raquo;
					<a href="viewCategoryAdmin?categoryId=<bean:write name='ancestorCategory' property='id' />"><bean:write name="ancestorCategory" property="name" /></a>
				</logic:iterate>
	...
	<h3><bean:write name='currentCategoryName' /> sub-categories:</h3>
