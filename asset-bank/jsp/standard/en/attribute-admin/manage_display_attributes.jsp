...
<body id="adminPage">
	...
	<p class="tabHolder">
		...
		<a href="viewManageDisplayAttributes?daGroupId=2" <c:if test='${selectedGroupId == 2 || selectedGroupId == 5 || selectedGroupId == 4 || selectedGroupId == 11}'>class="active"</c:if>>Browsing</a>
		...
		<a href="viewManageDisplayAttributes?daGroupId=12" <c:if test='${selectedGroupId == 12}'>class="active"</c:if>>Publishing</a>
	...
	<div id="tabContent" style="overflow:hidden;">
		<c:choose>
			<c:when test="${selectedGroupId == 2 || selectedGroupId == 5 || selectedGroupId == 4 || selectedGroupId == 11}">
				...
				<ul class="linkList">
					...
					<li <c:if test='${selectedGroupId == 11}'>class="active"</c:if>><a href="viewManageDisplayAttributes?daGroupId=11">Browsing (compact view)</a></li>
		...
		<c:choose>
			...
			<c:when test="${selectedGroupId == 11}">
				<!-- Browse (list view) -->
				<p>Change which attributes to display (and in which order) when browsing in compact view.</p>
			</c:when>
			...
			<c:when test="${selectedGroupId == 12}">
				<!-- Download Filename page -->
				<p>Change which attributes are used to construct the filename that will be used when an asset is published.</p>
			</c:when>
		</c:choose>
