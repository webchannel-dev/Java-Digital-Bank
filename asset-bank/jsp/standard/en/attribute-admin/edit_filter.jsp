					...
					<logic:greaterThan name="translation" property="language.id" value="0">
						<tr>
							...
							<td>
								...
								<input type="text" class="text" name="filter.translations[<bean:write name='tIndex'/>].name" maxlength="255" id="name<bean:write name='tIndex'/>" value="<bean:write name="translation" property="name" />"/>
							</td>
						</tr>
					</logic:greaterThan>
				</logic:iterate>	
