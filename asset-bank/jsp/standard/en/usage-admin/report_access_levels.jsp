...
<body id="adminPage">
	...
	<h2><bean:write name="reportType" /> by Access Level</h2>
	...
	<logic:notEmpty name="reportForm" property="details">		
		...
		<p>Total number of <bean:write name="reportType" /> in the selected period: <strong><c:out value="${reportForm.totalTimes}" /></strong>.</p>			
		
		<table class="report" cellspacing="0">
			<tr>
				<th>Access Level</th>
				<th class="downloads">Number of <bean:write name="reportType" /></th>
			</tr>
			<logic:iterate name="reportForm" property="details" id="item" indexId="i">
				...
				<tr>
					...
					<td class="downloads">
						<strong>
							<c:if test="${reportForm.showViews}">
								<bean:write name="item" property="numViews" />
							</c:if>
							<c:if test="${reportForm.showDownloads}">
								<bean:write name="item" property="numDownloads" />
							</c:if>
						</strong>
					</td>
