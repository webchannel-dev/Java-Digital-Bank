...
<body id="adminPage">
	...
	<logic:empty name="reportForm" property="details">
		...
		<p>If you are expecting to see downloads shown here then it may be that your naming attribute is not properly set. Please visit the <a href="viewManageNameAttributes">Name Attributes page</a> select a name attribute and reindex the images before returning to this report.</p>
	</logic:empty>
		...
		<table cellspacing="0" class="report" summary="Usage report">		
			...
			<logic:iterate name="reportForm" property="details" id="detail">
				<tr>
					...
					<td>
						<bean:write name="detail" property="reasonForDownload" />
					...
					<td>
						<c:if test="${detail.userId > 0}">
							<bean:write name="detail" property="userFullname" /> (<bean:write name="detail" property="username" />)
						</c:if>
						<c:if test="${detail.userId <= 0}">
							Public User
						</c:if>
					...
					<td>
						<logic:notEmpty name="detail" property="countryName">
							<bean:write name="detail" property="countryName" />
						</logic:notEmpty>
					...
					<td>
						<logic:notEmpty name="detail" property="organisation">
							<bean:write name="detail" property="organisation" />
						</logic:notEmpty>
