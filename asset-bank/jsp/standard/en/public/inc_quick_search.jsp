		...
		>
			...
			<html:form action="quickSearch" method="get" styleClass="">
				...
				<div class="inner"> 
					...
					<c:choose>
						<c:when test="${showCategoriesOnQuickSearch == 'radio'}">
							<c:set var="browserCategories" value="${homepageForm.descriptiveCategories}" scope="request" />
						...
						<c:when test="${showCategoriesOnQuickSearch == 'list'}">
							<c:set var="browserCategories" value="${homepageForm.descriptiveCategories}" scope="request" />
