...
<body id="searchPage">
		...
		<table>
			<logic:iterate name="savedSearchForm" property="savedSearches" id="search">
				<tr>
					...
					<td style="padding-left: 8px;">
						<a href="runSavedSearch?id=<bright:write name="search" property="id"/>"><bright:cmsWrite identifier="link-run" filter="false"/></a>
						<c:if test="${canCreateSearchRss}">
							|
							<c:if test="${search.rssFeed}">
						...
						| <a href="viewSavedSearch?id=<bright:write name="search" property="id" encodeForUrl="true"/>"><bright:cmsWrite identifier="link-edit" filter="false"/></a>
						| <a href="deleteSavedSearch?id=<bright:write name="search" property="id" encodeForUrl="true"/>" onclick="return confirm('<bright:cmsWrite identifier="js-confirm-delete-saved-search" filter="false"/>');"><bright:cmsWrite identifier="link-delete" filter="false"/></a>
					</td>
				</tr>
			</logic:iterate>
		</table>
	...
	<c:if test="${userprofile.isAdmin}">
		...
		<h2><bright:cmsWrite identifier="heading-recommended-searches" filter="false"/></h2>
		
		<logic:notEmpty name="savedSearchForm" property="recommendedSearches">
			<table>
				<logic:iterate name="savedSearchForm" property="recommendedSearches" id="search">
					<tr>
						<td><bean:write name="search" property="name" filter="false"/></td>
						<c:if test="${canCreateSearchRss}">
							<td>
						...
						<td style="padding-left: 8px;">
							<bright:write name="search" property="user.forename" /> <bright:write name="search" property="user.surname" />
						</td>
						<td style="padding-left: 8px;">
							<a href="runSavedSearch?id=<bright:write name="search" property="id"/>"><bright:cmsWrite identifier="link-run" filter="false"/></a>
							<c:if test="${canCreateSearchRss}">
		...
		<logic:empty name="savedSearchForm" property="recommendedSearches">
			<p><bright:cmsWrite identifier="snippet-no-recommended-searches" filter="false"/></p>
		</logic:empty>
		
		
		<div class="hr"></div>
		
		<h2><bright:cmsWrite identifier="heading-featured-searches" filter="false"/></h2>
		
		<logic:notEmpty name="savedSearchForm" property="featuredSearches">
			<table>
				<logic:iterate name="savedSearchForm" property="featuredSearches" id="search">
					<tr>
						<td><bean:write name="search" property="name" filter="false"/></td>
						<c:if test="${canCreateSearchRss}">
							<td>
		...
		<logic:empty name="savedSearchForm" property="featuredSearches">
			<p><bright:cmsWrite identifier="snippet-no-featured-searches" filter="false"/></p>
		</logic:empty>
	</c:if>
