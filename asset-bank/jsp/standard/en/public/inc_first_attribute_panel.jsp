...
<c:if test="${not empty firstAttributeValue && not empty firstAttributeValue.value && firstAttributeValue.attribute.isVisible}">
	<div class="firstAttributePanel-<bean:write name="firstAttributePosition"/>">
		<c:if test="${firstAttributeShowLabel && firstAttributeValue.attribute.isTextarea}">
			<div class="firstAttributePanelLabel-<bean:write name="firstAttributePosition"/>"><bean:write name="firstAttributeValue" property="attribute.label" /></div>
		</c:if>
		<c:if test="${firstAttributeShowLabel && !firstAttributeValue.attribute.isTextarea}">
			<span class="firstAttributePanelLabel-<bean:write name="firstAttributePosition"/>"><bean:write name="firstAttributeValue" property="attribute.label" />:</span>
		</c:if>
		<c:choose>
