	...
	<table cellpadding="0" cellspacing="0" border="0" class="admin">
		<c:if test="${not empty version.createdByUser}">
			<tr>
				...
				<td><bean:write name="version" property="createdByUser.fullName" /> <c:if test="${not empty version.createdByUser.emailAddress}"><bean:write name="version" property="createdByUser.emailAddress" /></c:if>
				</td>
			</tr>
		</c:if>
		<tr>
