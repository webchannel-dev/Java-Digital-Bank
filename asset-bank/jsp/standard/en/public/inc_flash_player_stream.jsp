		...
		$j(function(){
			...
			var settings = {
				...
				validationMessages: {
					...
					end: 'Your end point must be after your start point.\n',
					overstart: 'Your start point must be before the video end.\n',
					overend: 'Your end point must not be after the video end.\n'
