...
<body id="searchPage">
	...
	<logic:notEmpty name="savedSearchForm" property="savedSearches">
		...
		<table class="admin">
			...
			<logic:iterate name="savedSearchForm" property="savedSearches" id="search">
				<tr>
					<td><bean:write name="search" property="name" /></td>
					...
					<td style="padding-left: 8px;"><a href="deleteSavedSearchFromSaveSearch?id=<bright:write name="search" property="id" encodeForUrl="true"/>" onclick="return confirm('<bright:cmsWrite identifier="js-confirm-delete-saved-search" filter="false"/>');"><bright:cmsWrite identifier="link-delete" filter="false"/></a></td>
				</tr>
			</logic:iterate>
		</table>
		<br/>
	...
	<c:if test="${not empty savedSearchForm.savedSearch.keywords}">
		<p><bright:cmsWrite identifier="snippet-save-search" filter="false"/> "<bean:write name="savedSearchForm" property="savedSearch.keywords" />"</p>
	</c:if>
