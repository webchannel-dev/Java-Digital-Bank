...
<head>
	...
	<bean:define id="helpsection" value="downloadAudio"/>
					...
					<div>
						<div class="dialogPanel" style="margin-bottom:0;">
								...
								<div id="advOptions">
									...
									<bean:define name="downloadForm" property="listAudioDownloadOptions" id="listAudioDownloadOptions"/>
										<html:select name="downloadForm" styleId="audioBitrate" property="audioBitrate">
											<option value=""><bright:cmsWrite identifier="snippet-please-select" filter="false"/></option>
											<html:options collection="listAudioDownloadOptions" property="bitrate.formNumber" labelProperty="label"/>
										</html:select>
									</div>
