		...
		<c:if test="${ ( (accessLevelsOnHomepage=='all' || accessLevelsOnHomepage=='admin' && userprofile.isAdmin) && browserNumCategories gt 0 && ( !hideSingleAccessLevelOnHomepage || browserNumCategories gt 1 ) )}">	
