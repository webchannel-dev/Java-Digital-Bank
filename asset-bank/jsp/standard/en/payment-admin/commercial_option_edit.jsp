					...
					<logic:greaterThan name="translation" property="language.id" value="0">
						<tr>
							...
							<td>
								...
								<input type="text" class="text" name="commercialOption.translations[<bean:write name='tIndex'/>].name" maxlength="40" id="commercialOption<bean:write name='tIndex'/>" value="<bean:write name="translation" property="name" />"/>
							</td>
						</tr>
					</logic:greaterThan>
				</logic:iterate>
