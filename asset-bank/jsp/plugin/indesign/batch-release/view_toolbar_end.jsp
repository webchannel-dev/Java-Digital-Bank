...
<c:if test="${userprofile.canManageBatchReleases && not batchReleaseForm.pending}">
	<div class="group first" style="float:right">
		<a href="inDesignRegenerateAllPDFsInBatchRelease?brId=<bean:write name='batchReleaseForm' property='id'/>" class="button"><bright:cmsWrite identifier="button-regenerate-all-pdfs-in-batch-release"/></a>
	</div>
</c:if>
