...
<body id="adminPage">
	...
	<div style="float:left; margin-left: 2em; padding-left: 2em; border-left: 1px dashed #ccc; width: 50%">
		...
		<p>
			...
			<ul>
				<li>this feature will be visible on public assets only</li>
				<li>you must set "application-url" setting in <em>ApplicationSettings.properties</em> in order to generate a valid link (which will be used by facebook) to your website</li>
			</ul>
		</p>
