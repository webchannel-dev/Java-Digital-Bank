...
<head>
	...
	<title><bright:cmsWrite identifier="title-password-changed" filter="false"/></title> 
...
<body id="profilePage">
	...
	<h1 class="underline"><bright:cmsWrite identifier="heading-password-changed" filter="false" /></h1> 		 
	...
	<bright:cmsWrite identifier="intro-password-changed" filter="false"/>	
