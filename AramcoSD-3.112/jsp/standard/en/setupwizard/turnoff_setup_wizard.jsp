...
<body id="errorPage">
	...
	<div class="wrapper">  
		<h1>Setup Wizard</h1>
		<h2>Turn Off Setup Wizard</h2>
	
		<p>The Setup Wizard has been disabled.</p>
		<p>You should now <a href="<bean:write name="setupWizardForm" property="tomcatReloadUrl"/>">restart the application </a>.</p>
		<p>
