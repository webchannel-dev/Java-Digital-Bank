...
<%@ taglib uri="/WEB-INF/bright-tag.tld" prefix="bright" %>
	...
	<c:if test="${!hideDescriptiveCategories}">
	...
	<%-- There is no test here analagous to <logic:equal name="assetForm" property="areCategoriesVisible" value="true">
		 because this would break some places that include this JSP.  For
		 example when adding an asset there always need to be some access levels
		 set. --%>
