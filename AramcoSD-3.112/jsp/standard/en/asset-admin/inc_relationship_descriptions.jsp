	...
	<logic:iterate name='assetDescriptions' id="assetDescription" indexId="myIndex">
		<li class="selected <c:if test="${myIndex==0}">first</c:if>">
			...
			<table cellspacing="0" width="100%">
				<tr>
					<td class="image">
						<img src="../servlet/display?file=<bean:write name='assetDescription' property='object.displayThumbnailImageFile.path' />" alt="<bean:write name='assetDescription' property='object.id' />" /> 
					</td>	
					<td style="width: 48%;">
