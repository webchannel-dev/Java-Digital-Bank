...
<body id="detailsPage">
	...
	<html:form action="saveAssetRelationships" method="post" styleClass="floated">
		...
		<c:if test="${assetForm.entityCanHaveParents}">
			<label for="parentIds">
				<c:if test="${not empty assetForm.asset.entity.childRelationshipFromName}"><bean:write name="assetForm" property="asset.entity.childRelationshipFromName" filter="false"/></c:if>
		...
		<c:if test="${assetForm.asset.entity.allowChildren}">
			...
			<label for="childIds"><bean:write name="assetForm" property="asset.entity.childRelationshipToName" filter="false"/> <bright:cmsWrite identifier="label-ids" filter="false"/></label>
		...
		<c:if test="${assetForm.asset.entity.allowPeers}">
			...
			<label for="peerIds"><bean:write name="assetForm" property="asset.entity.peerRelationshipToName" filter="false"/> <bright:cmsWrite identifier="label-ids" filter="false"/></label>
