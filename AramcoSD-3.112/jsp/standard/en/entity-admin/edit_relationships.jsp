					...
					<logic:iterate name="assetEntityForm" property="entity.translations" id="translation" indexId="tIndex">
						<tr>
							<logic:greaterThan name="translation" property="language.id" value="0">
								...
								<td>
									<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].peerRelationshipToName" size="20" maxlength="60" id="peerRelToName<bean:write name='tIndex'/>" value="<bean:write name="translation" property="peerRelationshipToName" filter="false"/>"/> / <input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].peerRelationshipToNamePlural" size="20" maxlength="60" id="peerRelToNamePlural<bean:write name='tIndex'/>" value="<bean:write name="translation" property="peerRelationshipToNamePlural" filter="false"/>"/>
								</td>
							</logic:greaterThan>
						</tr>
					</logic:iterate>
					...
					<logic:iterate name="assetEntityForm" property="entity.translations" id="translation" indexId="tIndex">
						<logic:greaterThan name="translation" property="language.id" value="0">
							<tr>
								...
								<td>
								<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].childRelationshipToName" maxlength="60" id="childRelToName<bean:write name='tIndex'/>" value="<bean:write name="translation" property="childRelationshipToName" filter="false"/>"/> /
								<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].childRelationshipToNamePlural" maxlength="60" id="childRelToNamePlural<bean:write name='tIndex'/>" value="<bean:write name="translation" property="childRelationshipToNamePlural" filter="false"/>"/>
								</td>
							</tr>	
						</logic:greaterThan>
					</logic:iterate>
					...
					<logic:iterate name="assetEntityForm" property="entity.translations" id="translation" indexId="tIndex">
						<logic:greaterThan name="translation" property="language.id" value="0">
								<tr>
									...
									<td>
										<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].childRelationshipFromName" maxlength="60" id="childRelFromName<bean:write name='tIndex'/>" value="<bean:write name="translation" property="childRelationshipFromName" filter="false"/>"/> /
										<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].childRelationshipFromNamePlural" maxlength="60" id="childRelFromNamePlural<bean:write name='tIndex'/>" value="<bean:write name="translation" property="childRelationshipFromNamePlural" filter="false"/>"/>
									</td>
								</tr>	
							</logic:greaterThan>
					</logic:iterate>
					...
					<logic:iterate name="assetEntityForm" property="entity.translations" id="translation" indexId="tIndex">
						<logic:greaterThan name="translation" property="language.id" value="0">
							<tr>
								...
								<td>
									<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].termForSibling" maxlength="60" value="<bean:write name="translation" property="termForSibling" filter="false"/>"/> /
									<input type="text" class="text" name="entity.translations[<bean:write name='tIndex'/>].termForSiblings" maxlength="60" value="<bean:write name="translation" property="termForSiblings" filter="false"/>"/>
								</td>	
							</tr>	
						</logic:greaterThan>
					</logic:iterate>
