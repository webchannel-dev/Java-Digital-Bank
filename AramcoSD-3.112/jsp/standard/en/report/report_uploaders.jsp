		...
		<div class="hr"></div>
			...
			<table cellspacing="0" class="form" summary="Usage report">
					...
					<tr>
						...
						<td><bean:write name="order" property="forename" filter="false"/>&nbsp;<bean:write name="order" property="surname" filter="false"/>&nbsp;(<bean:write name="order" property="username" filter="false"/>)</td>
						<td><bean:write name="order" property="emailAddress" filter="false"/></td>
						<td><bean:write name="order" property="assetsSold"/></td>
						<td><bean:write name="order" property="totalIncome.displayAmount" filter="false"/></td>
					</tr>
					</logic:iterate>
					...
					<tr>
						<td colspan="3"></td>
						<td><em>Total:</em>&nbsp;&nbsp;</td>
						<td><bean:write name="ecommerceReportForm" property="total.displayAmount" filter="false"/></td>
					</tr>
			</table>
		<div class="hr"></div>
	</logic:notEmpty>
