...
<div class="copy">
		...
		<logic:empty name="workflowAuditForm" property="approvalAudit">
			<tr>
				...
				<td colspan="4" class="left">
					<bright:cmsWrite identifier="copy-no-messages" filter="false"/>
				</td>
			</tr>
		</logic:empty>
	...
	<input type="button" value="<bright:cmsWrite identifier='button-close' filter='false' />" class="button" id="closeButton" onclick="window.close();">
