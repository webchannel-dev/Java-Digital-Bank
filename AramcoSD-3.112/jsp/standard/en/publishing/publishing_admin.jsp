 			...
 			<tbody>
				<logic:iterate name="publishingForm" property="publishingActions" id="publishingAction">
					<tr id="publishing-action-<c:out value="${publishingAction.id}" />" class="publishing-action-item">
						...
						<td class="item-name"><bean:write name="publishingAction" property="fileTransferType" filter="false"/></td>
						...
						<td class="action">[<a class="run-link" title="Run this publishing action now" href="runPublishingAction?publishingActionId=<bean:write name="publishingAction" property="id" filter="false"/>&publishAll=1" onclick="if (!confirm('Are you sure you want to publish all assets in this access level? This may take a long time')) return false;">publish all matching assets</a>]</td>
						<td class="action">[<a class="run-link" title="Run this publishing action now" href="runPublishingAction?publishingActionId=<bean:write name="publishingAction" property="id" filter="false"/>">publish changed assets</a>]</td>
