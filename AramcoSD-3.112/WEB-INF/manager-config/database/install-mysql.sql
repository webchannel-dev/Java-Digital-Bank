...
Create table AssetBankUser (
	...
	ReactivationPending Bool DEFAULT 0,
...
Create table UserGroup (
	...
	AutomaticBrandRegister Bool DEFAULT 0,
	AdvancedViewing Bool NOT NULL DEFAULT 0,
 Primary Key (Id)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table SavedSearch (
	...
	AvailableToAll Bool DEFAULT 0,
	Featured Bool DEFAULT 0,
	SearchImage Varchar(250),
	NewAssetAlert Bool DEFAULT 0,
	SearchCriteriaFile Varchar(250),
...
Create table AssetAttributeValues (
	...
	activationdate Date,
	expirydate Date,
	usagerightsother Varchar(2000),
	sensitivitynotes Varchar(2000),
 Primary Key (AssetId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table RepurposedSlideshow (
	...
	SearchCriteriaFile Varchar(255),
	...
	ImageWidth Int,
	Description Varchar(255),
	ShowOnHomepage Bool NOT NULL,
	IsDefaultOnHomepage Bool NOT NULL,
	SequenceNumber Int,
...
Create table RepurposedAsset (
	...
	AssetId Bigint NOT NULL,
	PreviewFileLocation Varchar(250),
	RepurposedVersionId Bigint NOT NULL,
...
Create table AssetEntityDepRule (
	SourceAssetEntityId Bigint NOT NULL,
	DependentAssetEntityId Bigint NOT NULL,
	DepRuleTrigger Varchar(1) NOT NULL COMMENT 'Which part of the source triggers this dependency rule? ''F'' = File, ''A'' = Attributes',
	DepRuleActionId Bigint NOT NULL,
 Primary Key (SourceAssetEntityId,DependentAssetEntityId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table Request (
	Id Bigint NOT NULL AUTO_INCREMENT,
	FulfillmentUserId Bigint NOT NULL,
...
Alter table FeaturedAsset add Index IX_FeaturedAsset_Asset_FK (AssetId);
...
Alter table AssetEntityDepRule add Index IX_AEDR_AE_Source_FK (SourceAssetEntityId);
Alter table AssetEntityDepRule add Constraint AEDR_AE_Source_FK Foreign Key (SourceAssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
Alter table AssetEntityDepRule add Index IX_AEDR_AE_Dep_FK (DependentAssetEntityId);
Alter table AssetEntityDepRule add Constraint AEDR_AE_Dep_FK Foreign Key (DependentAssetEntityId) references AssetEntity (Id) on delete  restrict on update  restrict;
...
Alter table AssetEntityDepRule add Index IX_AEDR_DRA_FK (DepRuleActionId);
Alter table AssetEntityDepRule add Constraint AEDR_DRA_FK Foreign Key (DepRuleActionId) references DepRuleAction (Id) on delete  restrict on update  restrict;
...
INSERT INTO ListItem (LanguageId, Identifier, ListId, Title, Body, CannotBeDeleted, ListItemTextTypeID) VALUES (1,'label-user-receive-alerts-note', 9, 'Label - Receive Alerts Note', 'Check this if you want to receive alert emails generated by the system.', 1, 2);
