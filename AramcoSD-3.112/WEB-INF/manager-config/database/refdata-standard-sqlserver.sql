...
-- To generate refdata-standard-sqlserver.sql, run the ant target db-sqlserver-refdata-standard (replaces "" with "").
...
-- PSD conversion
INSERT INTO FileFormat (Id, Name, Description, FileExtension, AssetTypeId, IsIndexable, IsConvertable, IsConversionTarget, ThumbnailFileLocation, ContentType) VALUES (10,'PSD','Photoshop','psd',2,0,1,0,null,null);
UPDATE FileFormat SET ConverterClass = null WHERE Id = 10;
...
-- The contents of PDF and Word documents are indexed by default. This may slow down searches, if you have very large documents. See IsIndexable=0 to switch off.
...
INSERT INTO FileFormat (Id, Name, Description, FileExtension, AssetTypeId, IsIndexable, IsConvertable, IsConversionTarget, ThumbnailFileLocation, ContentType, ToTextConverterClass) VALUES (107,'PDF','Adobe PDF','pdf',1,1,0,0,'thumbnails/pdf_icon.gif','application/pdf','com.bright.assetbank.converter.PDFToTextConverter');
