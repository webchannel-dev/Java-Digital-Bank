...
Built on <a href="http://flashpanoramas.com/player/">Flash Panorama Player</a>.</div> 
    <script type="text/javascript">
	  ...
	  so.addVariable("xml_text", "<?xml version = '1.0'?><panorama><parameters> panoName=<c:out value="${fileUrl}"/>; layer_1=../flash/custom/pano/files/fps.swf; layer_6=../flash/custom/pano/files/cylConverter.swf; panoType=cylinder; panHome=80; layer_5 = ../flash/custom/pano/files/openFullscreen.swf; zoomhome=0.0; segments=40; layer_2=../flash/custom/pano/files/hotspots.swf; layer_10=../flash/custom/pano/files/autorotator.swf; layer_4=../flash/custom/pano/files/loadMeter.swf;</parameters></panorama>");
