...
<c:choose>
	<c:when test="${useBrands && userprofile.brand.id gt 0}">
		...
		<a href="../action/viewHome">
			<img src="<c:out value='${logoPath}' />" alt="<c:out value='${logoAlt}' />" width="<c:out value='${logoWidth}' />px" height="<c:out value='${logoHeight}' />px" class="logo" />
		</a> 

	</c:when>
	<c:otherwise>

		<a href="../action/viewHome"><img src="../images/standard/Saudi_Aramco_logo.png" alt="Saudi Aramco" width="160" height="40" class="logo" /></a> 
