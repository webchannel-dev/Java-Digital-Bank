...
<body id="homePage">
   ...
   <div id="rightCol">
		...
		<c:if test="${numPromoted >0}">
			<div class="promo">
				...
				<logic:iterate name="homepageForm" property="promotedAssets" id="image" indexId="index">
					<a class="imgWrapper squareThumb<c:out value="${index+1}"/> <logic:empty name="image" property="homogenizedImageFile.path">iconWrapper</logic:empty>" href="../action/viewAsset?id=<bean:write name='image' property='id'/>"  title="<c:out value='${image.searchName}'/>">
	...
	<div id="leftCol">
        ...
        <iframe src="../slidshow.html" width="560" height="315" scrolling="no"  style="border-width:0.1px; border-style:solid; border-color:#CCCCCC;">
</iframe>
