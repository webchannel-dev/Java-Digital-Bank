...
Create table Attribute (
	...
	IsSearchField Bool NOT NULL DEFAULT 0,
	...
	IsSearchBuilderField Bool NOT NULL DEFAULT 1,
...
Create table SavedSearch (
 ...
 Primary Key (Name,UserId)) ENGINE = InnoDB
DEFAULT CHARACTER SET utf8;
...
Create table AssetWorkflowAudit (
 ...
 Primary Key (Id,AssetId)) ENGINE = InnoDB;
...
Create table BatchReleasedNotifications (
	...
	BatchReleaseId Bigint NOT NULL,
 Primary Key (MessageId,BatchReleaseId)) ENGINE = InnoDB;
...
Alter table AssetWorkflowAudit add Constraint Relationship282 Foreign Key (AssetId) references Asset (Id) on delete  restrict on update  restrict;
...
Alter table AssetWorkflowAudit add Constraint Relationship284 Foreign Key (UserId) references AssetBankUser (Id) on delete  restrict on update  restrict;
...
Alter table BatchReleasedNotifications add Constraint BatchRelNot_Message_FK Foreign Key (MessageId) references Message (Id) on delete  restrict on update  restrict;
...
Alter table BatchReleasedNotifications add Constraint BatchRelNot_BatchRel_FK Foreign Key (BatchReleaseId) references BatchRelease (Id) on delete  restrict on update  restrict;
...
Alter table InDesignAsset add Index IX_InDAsset_InDPDFStatus_FK (PDFStatusId);
