...
<%-- Always show the date range form --%>
	<div style="padding:1em 0;">
		...
		<p><span class="inlineLabel"><bright:cmsWrite identifier="e-label-from" filter="false"/></span> <html:text styleClass="small text" name="reportForm" property="startDateString" size="20"/> 
		...
		&nbsp;
		<span class="inlineLabel"><bright:cmsWrite identifier="e-label-to" filter="false"/></span> <html:text styleClass="small text" name="reportForm" property="endDateString" size="20"/> 
