...
<body id="adminPage">
	...
	<%@include file="../report/inc_report_tabs.jsp"%>
		...
		<br />
		<div id="reportSelect">
		<label for="startDate">From:</label> <html:text styleClass="small text" name="searchReportForm" property="startDateString" size="20" styleId="startDate" /> 
		...
		&nbsp;
		<label for="endDate">To:</label> <html:text styleClass="small text" name="searchReportForm" property="endDateString" size="20" styleId="endDate" /> 
