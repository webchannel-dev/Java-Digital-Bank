			...
			<tr>
				<td>
					...
					<c:if test="${userprofile.isAdmin && not empty version.createdByUser}"> 
						by <bean:write name="version" property="createdByUser.fullName" filter="false"/> <c:if test="${not empty version.createdByUser.emailAddress}">(<bean:write name="version" property="createdByUser.emailAddress" filter="false"/>)</c:if>
					</c:if>
