		...
		<table cellpadding="0" cellspacing="0" border="0" class="admin">
			<c:if test="${not empty video.createdByUser}">
				<tr>
					...
					<td><bean:write name="video" property="createdByUser.fullName" filter="false"/> <c:if test="${not empty video.createdByUser.emailAddress}"><bean:write name="video" property="createdByUser.emailAddress" filter="false"/></c:if>
					</td>
				</tr>
			</c:if>
			<tr>
