...
<bean:define name="searchBuilderForm" property="searchAttributes" id="attributes"/>
...
<body id="searchPage" onload="<c:if test='${searchBuilderForm.areCategoriesVisible}'>setDescSelectedCategories();</c:if> setPermSelectedCategories(); setCatIdsFields();">
	...
	<html:form enctype="multipart/form-data" action="searchWithBuilder" method="get"> 
