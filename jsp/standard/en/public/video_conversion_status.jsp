...
<head>
	...
	<logic:equal name="downloadForm" property="conversionInProgress" value="true">
		<meta HTTP-EQUIV="refresh" CONTENT="5;URL=viewVideoConversionStatus<c:if test="${downloadForm.repurpose}">?repurpose=true&assetId=<bean:write name="downloadForm" property="asset.id"/></c:if>"></meta>
	</logic:equal>
	<logic:equal name="downloadForm" property="conversionInProgress" value="false">
		<meta HTTP-EQUIV="refresh" CONTENT="1;URL=viewVideoConversionStatus?filePath=<bean:write name='downloadForm' property='videoConversionResult.convertedFilename'/>&compressAsset=<bean:write name='downloadForm' property='videoConversionResult.compress'/><c:if test="${downloadForm.repurpose}">&repurpose=true&assetId=<bean:write name="downloadForm" property="asset.id"/></c:if>">
	</logic:equal>
