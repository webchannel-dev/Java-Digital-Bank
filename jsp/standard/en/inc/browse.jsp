	...
	<c:when test='${ numResults > 0 }'>
		...
		<c:choose>
			<c:when test="${panel.listView}">
				<bright:refDataList componentName="AttributeManager" methodName="getBrowseListDisplayAttributeLabels" id="displayAttributes" transactionManagerName="DBTransactionManager" passUserprofile="true"/>
