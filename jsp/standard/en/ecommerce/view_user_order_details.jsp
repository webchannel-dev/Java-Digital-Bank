			...
			<logic:iterate name="orderForm" property="order.assets" id="asset">
				<logic:iterate name="asset" property="priceBands" id="priceBand" indexId="pbIndx">
					<tr>
						...
						<logic:notEqual name="usePriceBands" value="true">
							<td>
								<bean:write name="asset" property="price.displayAmount" filter="false"/>
							</td>
						</logic:notEqual>
					</tr>
				</logic:iterate>
				<logic:equal name="usePriceBands" value="true">
					<logic:equal name="orderForm" property="order.personal" value="true">
						<tr>
							...
							<td>
								<strong>
									<bean:write name="asset" property="price.displayAmount" filter="false" format="italic"/>
								</strong>	
							</td>
							<logic:notEqual name="orderForm" property="order.shippingAddress.id" value="0">
								<logic:equal name="shippingCalculationType" value="1">	
			...
			<tr>
				...
				<td>
					<c:choose>
						...
						<c:otherwise>
							<bean:write name="orderForm" property="order.subtotal.displayAmount" filter="false"/>
						</c:otherwise>
					</c:choose>	
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<c:choose>
						...
						<c:otherwise>
							<bean:write name="orderForm" property="order.total.displayAmount" filter="false"/>
						</c:otherwise>
					</c:choose>	
