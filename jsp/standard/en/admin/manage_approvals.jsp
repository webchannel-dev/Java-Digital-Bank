						...
						<logic:iterate name="userForm" property="users" id="user">
							<tr>
								...
								<td>
									...
									<span alt="<bean:write name='user' property='registrationInfo'/>" title="<bean:write name='user' property='registrationInfo'/>"><bright:writeWithTruncateTag name="user" property="registrationInfo" maxLength="50" endString="..." filter="false"/></span>
								</td>
								</logic:equal>
								<c:if test="${additionalUserApprovalEnabled}">
									<td>
