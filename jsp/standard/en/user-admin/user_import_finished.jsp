...
<body id="adminPage">
	...
	<p>
	<bean:parameter name="numUsersAdded" id="numUsersAdded" value="0"/>
	The user import has completed. <strong><bean:write name="numUsersAdded"/></strong> users were successfully added.
	<br/>
	</p>
